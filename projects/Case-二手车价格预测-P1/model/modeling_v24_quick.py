...
def train_quick_models(X_train, y_train, X_test):
    """
    快速模型训练 - 减少迭代次数
    """
    print("训练快速模型...")
...
def quick_ensemble(lgb_pred, xgb_pred, cat_pred, scores_info):
    """
    快速集成策略
    """
    print("执行快速集成策略...")
...
def quick_calibration(predictions, y_train):
    """
    快速校准
    """
...
def v24_quick_test():
    ...
    # 步骤1: 快速预处理
    print("\n步骤1: 快速预处理...")
    train_df, test_df = quick_preprocessing()
    ...
    # 步骤4: 快速模型训练
    print("\n步骤4: 快速模型训练...")
    lgb_pred, xgb_pred, cat_pred, scores_info = train_quick_models(
        X_train, y_train, X_test)
    
    # 步骤5: 快速集成
    print("\n步骤5: 快速集成...")
    ensemble_pred = quick_ensemble(lgb_pred, xgb_pred, cat_pred, scores_info)
    
    # 步骤6: 快速校准
    print("\n步骤6: 快速校准...")
    final_predictions = quick_calibration(ensemble_pred, y_train)
    ...
    result_file = os.path.join(result_dir, f"modeling_v24_quick_{timestamp}.csv")
...
if __name__ == "__main__":
    test_pred, scores_info = v24_quick_test()
    print("V24快速测试完成! 🚀")
