...
class KNeighborsClassifier(KNeighborsMixin, ClassifierMixin, NeighborsBase):
    ...
    def predict(self, X): # -> NDArray[Any] | ndarray[Any, dtype[float64]]:
    ...
    def predict_proba(self, X): # -> list[Any]:
...
class RadiusNeighborsClassifier(RadiusNeighborsMixin, ClassifierMixin, NeighborsBase):
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, radius=..., *, weights=..., algorithm=..., leaf_size=..., p=..., metric=..., outlier_label=..., metric_params=..., n_jobs=...) -> None:
        ...
    ...
    def predict(self, X): # -> ndarray[Any, dtype[float64]]:
        """Predict the class labels for the provided data.
