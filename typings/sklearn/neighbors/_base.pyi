...
class RadiusNeighborsMixin:
    ...
    def radius_neighbors(self, X=..., radius=..., return_distance=..., sort_results=...): # -> tuple[NDArray[Any] | Any, NDArray[Any]] | NDArray[Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any] | tuple[NDArray[Any], NDArray[Any]] | tuple[Any | NDArray[Any], Any | NDArray[Any] | tuple[NDArray[Any] | Any, NDArray[Any]] | tuple[NDArray[Any] | Any, NDArray[Any] | Any] | tuple[NDArray[Any], NDArray[Any]]] | Any:
