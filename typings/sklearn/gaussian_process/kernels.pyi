...
class Hyperparameter(namedtuple("Hyperparameter", ("name", "value_type", "bounds", "n_elements", "fixed"))):
    ...
    """
    __slots__ = ...
    def __new__(cls, name, value_type, bounds, n_elements=..., fixed=...): # -> Self:
        ...
...
class Kernel(metaclass=ABCMeta):
    ...
    def clone_with_theta(self, theta): # -> dict[Any, Any] | frozenset[Any] | list[Any] | set[Any] | tuple[Any, ...] | type:
    ...
    def __radd__(self, b): # -> Sum:
        ...
    
    def __mul__(self, b): # -> Product:
        ...
    
    def __rmul__(self, b): # -> Product:
        ...
    
    def __pow__(self, b): # -> Exponentiation:
        ...
    ...
    @abstractmethod
    def __call__(self, X, Y=..., eval_gradient=...): # -> None:
        """Evaluate the kernel."""
        ...
    ...
    @property
    def requires_vector_input(self): # -> Literal[True]:
...
class NormalizedKernelMixin:
    ...
    .. versionadded:: 0.18
    """
    def diag(self, X): # -> NDArray[float64]:
        """Returns the diagonal of the kernel k(X, X).
...
class StationaryKernelMixin:
    ...
    .. versionadded:: 0.18
    """
    def is_stationary(self): # -> Literal[True]:
        """Returns whether the kernel is stationary."""
        ...
...
class GenericKernelMixin:
    ...
    """
    @property
    def requires_vector_input(self): # -> Literal[False]:
...
class CompoundKernel(Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[Any], NDArray[Any]] | NDArray[Any]:
...
class Sum(KernelOperator):
    ...
    """
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[Any, NDArray[Any]]:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class Exponentiation(Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[Any, Any]:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class ConstantKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[Any], NDArray[Any]] | tuple[NDArray[Any], NDArray[float64]] | NDArray[Any]:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class WhiteKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[floating[Any]], NDArray[floating[Any]]] | tuple[NDArray[floating[Any]], NDArray[float64]] | NDArray[floating[Any]] | NDArray[float64]:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class RBF(StationaryKernelMixin, NormalizedKernelMixin, Kernel):
    ...
    @property
    def anisotropic(self): # -> TypeGuard[Iterable[Any]] | bool:
        ...
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[Any], NDArray[float64]] | tuple[NDArray[Any], ndarray[Any, dtype[Any]]] | tuple[NDArray[Any], Any] | NDArray[Any] | None:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class Matern(RBF):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[Any] | NDArray[floating[Any]] | Any, NDArray[float64]] | tuple[NDArray[Any] | NDArray[floating[Any]] | Any, NDArray[Any]] | tuple[NDArray[Any] | NDArray[floating[Any]] | Any, Any] | tuple[NDArray[Any] | NDArray[floating[Any]] | Any, Any | NDArray[Any] | NDArray[floating[Any]]] | NDArray[Any] | NDArray[floating[Any]] | Any:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class RationalQuadratic(StationaryKernelMixin, NormalizedKernelMixin, Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[floating[Any]], NDArray[float64]] | NDArray[floating[Any]]:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class ExpSineSquared(StationaryKernelMixin, NormalizedKernelMixin, Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[Any], NDArray[float64]] | NDArray[Any]:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class DotProduct(Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[Any, NDArray[float64]] | Any:
        """Return the kernel k(X, Y) and optionally its gradient.
    ...
    def is_stationary(self): # -> Literal[False]:
        """Returns whether the kernel is stationary."""
        ...
...
class PairwiseKernel(Kernel):
    ...
    @property
    def hyperparameter_gamma(self): # -> Hyperparameter:
        ...
    
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[Any, NDArray[float64]] | tuple[Any, NDArray[Any]]:
        """Return the kernel k(X, Y) and optionally its gradient.
    ...
    def diag(self, X): # -> ndarray[Any, dtype[float64]]:
        """Returns the diagonal of the kernel k(X, X).
