...
class ColumnTransformer(TransformerMixin, _BaseComposition):
    ...
    def __init__(self, transformers, *, remainder=..., sparse_threshold=..., n_jobs=..., transformer_weights=..., verbose=..., verbose_feature_names_out=..., force_int_remainder_cols=...) -> None:
        ...
    ...
    def fit_transform(self, X, y=..., **params): # -> NDArray[float64] | csr_matrix | csr_array | Any | NDArray[Any]:
    ...
    def transform(self, X, **params): # -> NDArray[float64] | csr_matrix | csr_array | Any | NDArray[Any]:
...
def make_column_transformer(*transformers, remainder=..., sparse_threshold=..., n_jobs=..., verbose=..., verbose_feature_names_out=..., force_int_remainder_cols=...): # -> ColumnTransformer:
