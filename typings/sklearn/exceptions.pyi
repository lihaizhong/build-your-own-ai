...
__all__ = ["ConvergenceWarning", "DataConversionWarning", "DataDimensionalityWarning", "EfficiencyWarning", "EstimatorCheckFailedWarning", "FitFailedWarning", "NotFittedError", "PositiveSpectrumWarning", "SkipTestWarning", "UndefinedMetricWarning", "UnsetMetadataPassedError"]
...
class EstimatorCheckFailedWarning(UserWarning):
    ...
    """
    def __init__(self, *, estimator, check_name: str, exception: Exception, status: str, expected_to_fail: bool, expected_to_fail_reason: str) -> None:
        ...
