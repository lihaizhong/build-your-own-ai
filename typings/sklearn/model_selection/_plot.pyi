...
class LearningCurveDisplay(_BaseCurveDisplay):
    ...
    def plot(self, ax=..., *, negate_score=..., score_name=..., score_type=..., std_display_style=..., line_kw=..., fill_between_kw=..., errorbar_kw=...): # -> Self:
        """Plot visualization.
    ...
    @classmethod
    def from_estimator(cls, estimator, X, y, *, groups=..., train_sizes=..., cv=..., scoring=..., exploit_incremental_learning=..., n_jobs=..., pre_dispatch=..., verbose=..., shuffle=..., random_state=..., error_score=..., fit_params=..., ax=..., negate_score=..., score_name=..., score_type=..., std_display_style=..., line_kw=..., fill_between_kw=..., errorbar_kw=...): # -> Self:
...
class ValidationCurveDisplay(_BaseCurveDisplay):
    ...
    @classmethod
    def from_estimator(cls, estimator, X, y, *, param_name, param_range, groups=..., cv=..., scoring=..., n_jobs=..., pre_dispatch=..., verbose=..., error_score=..., fit_params=..., ax=..., negate_score=..., score_name=..., score_type=..., std_display_style=..., line_kw=..., fill_between_kw=..., errorbar_kw=...): # -> Self:
