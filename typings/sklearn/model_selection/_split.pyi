...
"""
__all__ = ["BaseCrossValidator", "GroupKFold", "GroupShuffleSplit", "KFold", "LeaveOneGroupOut", "LeaveOneOut", "LeavePGroupsOut", "LeavePOut", "PredefinedSplit", "RepeatedKFold", "RepeatedStratifiedKFold", "ShuffleSplit", "StratifiedGroupKFold", "StratifiedKFold", "StratifiedShuffleSplit", "check_cv", "train_test_split"]
...
class BaseCrossValidator(_MetadataRequester, metaclass=ABCMeta):
    ...
    """
    __metadata_request__split = ...
    def split(self, X, y=..., groups=...): # -> Generator[tuple[ndarray[Any, dtype[signedinteger[Any]]], ndarray[Any, dtype[signedinteger[Any]]]], Any, None]:
        """Generate indices to split data into training and test set.
...
class LeaveOneOut(_UnsupportedGroupCVMixin, BaseCrossValidator):
    ...
    """
    def get_n_splits(self, X, y=..., groups=...): # -> Any | int:
        """Returns the number of splitting iterations in the cross-validator.
...
class _RepeatedSplits(_MetadataRequester, metaclass=ABCMeta):
    ...
    **cvargs : additional params
    ...
    def split(self, X, y=..., groups=...): # -> Generator[tuple[Any, Any], Any, None]:
...
class BaseShuffleSplit(_MetadataRequester, metaclass=ABCMeta):
    ...
    def split(self, X, y=..., groups=...): # -> Generator[tuple[ndarray[Any, dtype[long]] | Any, ndarray[Any, dtype[long]] | Any], Any, None]:
        """Generate indices to split data into training and test set.
...
def check_cv(cv=..., y=..., *, classifier=...): # -> StratifiedKFold | KFold | _CVIterableWrapper | int:
...
def train_test_split(*arrays, test_size=..., train_size=..., random_state=..., shuffle=..., stratify=...): # -> list[Any | list[Any]]:
