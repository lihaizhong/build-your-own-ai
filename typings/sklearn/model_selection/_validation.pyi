...
"""
__all__ = ["cross_val_predict", "cross_val_score", "cross_validate", "learning_curve", "permutation_test_score", "validation_curve"]
...
def cross_validate(estimator, X, y=..., *, groups=..., scoring=..., cv=..., n_jobs=..., verbose=..., params=..., pre_dispatch=..., return_train_score=..., return_estimator=..., return_indices=..., error_score=...): # -> dict[Any, Any]:
...
def cross_val_score(estimator, X, y=..., *, groups=..., scoring=..., cv=..., n_jobs=..., verbose=..., params=..., pre_dispatch=..., error_score=...):
...
def cross_val_predict(estimator, X, y=..., *, groups=..., cv=..., n_jobs=..., verbose=..., params=..., pre_dispatch=..., method=...): # -> list[Any] | csr_matrix | csc_matrix | csr_array | csc_array | Any:
...
def permutation_test_score(estimator, X, y, *, groups=..., cv=..., n_permutations=..., n_jobs=..., random_state=..., verbose=..., scoring=..., fit_params=..., params=...): # -> tuple[floating[Any], NDArray[Any], floating[_64Bit | Any]]:
...
def learning_curve(estimator, X, y, *, groups=..., train_sizes=..., cv=..., scoring=..., exploit_incremental_learning=..., n_jobs=..., pre_dispatch=..., verbose=..., shuffle=..., random_state=..., error_score=..., return_times=..., fit_params=..., params=...): # -> tuple[NDArray[Any], Any | ndarray[Any, dtype[Any]], Any | ndarray[Any, dtype[Any]], Any | ndarray[Any, dtype[Any]], Any | ndarray[Any, dtype[Any]]] | tuple[NDArray[Any], Any | ndarray[Any, dtype[Any]], Any | ndarray[Any, dtype[Any]]]:
    """Learning curve.
...
def validation_curve(estimator, X, y, *, param_name, param_range, groups=..., cv=..., scoring=..., n_jobs=..., pre_dispatch=..., verbose=..., error_score=..., fit_params=..., params=...): # -> tuple[ndarray[Any, dtype[Any]] | Any, ndarray[Any, dtype[Any]] | Any]:
    """Validation curve.
