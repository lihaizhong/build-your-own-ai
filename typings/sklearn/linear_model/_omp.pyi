...
def orthogonal_mp(X, y, *, n_nonzero_coefs=..., tol=..., precompute=..., copy_X=..., return_path=..., return_n_iter=...): # -> tuple[NDArray[float64], Any | list[Any]] | NDArray[float64]:
...
def orthogonal_mp_gram(Gram, Xy, *, n_nonzero_coefs=..., tol=..., norms_squared=..., copy_Gram=..., copy_Xy=..., return_path=..., return_n_iter=...): # -> tuple[NDArray[float64], Any | list[Any]] | NDArray[float64]:
