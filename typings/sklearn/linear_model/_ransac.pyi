...
from ..base import BaseEstimator, MetaEstimatorMixin, MultiOutputMixin, RegressorMixin, _fit_context
...
class RANSACRegressor(MetaEstimatorMixin, RegressorMixin, MultiOutputMixin, BaseEstimator):
    ...
    def __init__(self, estimator=..., *, min_samples=..., residual_threshold=..., is_data_valid=..., is_model_valid=..., max_trials=..., max_skips=..., stop_n_inliers=..., stop_score=..., stop_probability=..., loss=..., random_state=...) -> None:
        ...
    ...
    def score(self, X, y, **params): # -> float | Any:
