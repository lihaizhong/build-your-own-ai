...
def fit_binary(est, i, X, y, alpha, C, learning_rate, max_iter, pos_weight, neg_weight, sample_weight, validation_mask=..., random_state=...): # -> tuple[Any, Any, Any]:
...
class BaseSGDClassifier(LinearClassifierMixin, BaseSGD, metaclass=ABCMeta):
    ...
    def partial_fit(self, X, y, classes=..., sample_weight=...): # -> Self:
    ...
    @_fit_context(prefer_skip_nested_validation=True)
    def fit(self, X, y, coef_init=..., intercept_init=..., sample_weight=...): # -> Self:
...
class SGDClassifier(BaseSGDClassifier):
    ...
    def predict_proba(self, X): # -> NDArray[Any] | Any | NDArray[float64]:
...
class SGDOneClassSVM(OutlierMixin, BaseSGD):
    ...
    loss_functions = ...
    _parameter_constraints: dict = ...
    def __init__(self, nu=..., fit_intercept=..., max_iter=..., tol=..., shuffle=..., verbose=..., random_state=..., learning_rate=..., eta0=..., power_t=..., warm_start=..., average=...) -> None:
        ...
    ...
    @_fit_context(prefer_skip_nested_validation=True)
    def fit(self, X, y=..., coef_init=..., offset_init=..., sample_weight=...): # -> Self:
        """Fit linear One-Class SVM with Stochastic Gradient Descent.
