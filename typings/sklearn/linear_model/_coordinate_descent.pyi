...
def lasso_path(X, y, *, eps=..., n_alphas=..., alphas=..., precompute=..., Xy=..., copy_X=..., coef_init=..., verbose=..., return_n_iter=..., positive=..., **params): # -> tuple[NDArray[Any] | Any | ndarray[Any, dtype[Any]], NDArray[float64], NDArray[float64], list[Any]] | tuple[NDArray[Any] | Any | ndarray[Any, dtype[Any]], NDArray[float64], NDArray[float64]]:
...
def enet_path(X, y, *, l1_ratio=..., eps=..., n_alphas=..., alphas=..., precompute=..., Xy=..., copy_X=..., coef_init=..., verbose=..., return_n_iter=..., positive=..., check_input=..., **params): # -> tuple[NDArray[Any] | Any | ndarray[Any, dtype[Any]], NDArray[float64], NDArray[float64], list[Any]] | tuple[NDArray[Any] | Any | ndarray[Any, dtype[Any]], NDArray[float64], NDArray[float64]]:
