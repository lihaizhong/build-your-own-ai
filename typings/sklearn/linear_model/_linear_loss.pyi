...
class LinearModelLoss:
    ...
    def loss_gradient(self, coef, X, y, sample_weight=..., l2_reg_strength=..., n_threads=..., raw_prediction=...): # -> tuple[Any, Any | ndarray[Any, dtype[float64]]]:
    ...
    def gradient(self, coef, X, y, sample_weight=..., l2_reg_strength=..., n_threads=..., raw_prediction=...): # -> ndarray[Any, dtype[float64]]:
    ...
    def gradient_hessian(self, coef, X, y, sample_weight=..., l2_reg_strength=..., n_threads=..., gradient_out=..., hessian_out=..., raw_prediction=...): # -> tuple[Any, NDArray[float64] | Any, Any] | tuple[Any, NDArray[float64] | Any, Any | Literal[False]]:
    ...
    def gradient_hessian_product(self, coef, X, y, sample_weight=..., l2_reg_strength=..., n_threads=...): # -> tuple[ndarray[Any, dtype[float64]], Callable[..., ndarray[Any, dtype[float64]]]] | tuple[Any | NDArray[float64], Callable[..., Any]]:
