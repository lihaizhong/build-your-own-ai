...
def mean_absolute_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> Any | float:
...
def mean_pinball_loss(y_true, y_pred, *, sample_weight=..., alpha=..., multioutput=...): # -> Any | float:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def mean_absolute_percentage_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> Any | float:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def mean_squared_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> Any | float:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def root_mean_squared_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> Any | float:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def mean_squared_log_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> Any | float:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def root_mean_squared_log_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> Any | float:
...
def median_absolute_error(y_true, y_pred, *, multioutput=..., sample_weight=...): # -> Any | float:
...
def explained_variance_score(y_true, y_pred, *, sample_weight=..., multioutput=..., force_finite=...): # -> float | Any:
...
def r2_score(y_true, y_pred, *, sample_weight=..., multioutput=..., force_finite=...): # -> float | Any:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"] }, prefer_skip_nested_validation=True)
...
def mean_tweedie_deviance(y_true, y_pred, *, sample_weight=..., power=...): # -> float:
...
def mean_poisson_deviance(y_true, y_pred, *, sample_weight=...): # -> float:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None] }, prefer_skip_nested_validation=True)
def mean_gamma_deviance(y_true, y_pred, *, sample_weight=...): # -> float:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"power": [Interval(Real, None, 0, closed="right"), Interval(Real, 1, None, closed="left")] }, prefer_skip_nested_validation=True)
def d2_tweedie_score(y_true, y_pred, *, sample_weight=..., power=...): # -> float:
    """
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"alpha": [Interval(Real, 0, 1, closed="both")],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def d2_pinball_score(y_true, y_pred, *, sample_weight=..., alpha=..., multioutput=...): # -> float | NDArray[float64]:
    """
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def d2_absolute_error_score(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> float | NDArray[float64]:
    """
