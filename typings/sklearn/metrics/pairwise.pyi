...
@validate_params({ "X": ["array-like", "sparse matrix"],"Y": ["array-like", "sparse matrix"],"axis": [Options(Integral, 0, 1)],"metric": [StrOptions(set(_VALID_METRICS).union(ArgKmin.valid_metrics())), callable],"metric_kwargs": [dict, None] }, prefer_skip_nested_validation=False)
def pairwise_distances_argmin(X, Y, *, axis=..., metric=..., metric_kwargs=...): # -> NDArray[float64]:
    """Compute minimum distances between one point and a set of points.
...
@validate_params({ "X": ["array-like", "sparse matrix"],"Y": ["array-like", "sparse matrix", None] }, prefer_skip_nested_validation=True)
def manhattan_distances(X, Y=...): # -> NDArray[float64] | NDArray[floating[Any]]:
...
def paired_euclidean_distances(X, Y): # -> Any:
...
@validate_params({ "X": ["array-like", "sparse matrix"],"Y": ["array-like", "sparse matrix"] }, prefer_skip_nested_validation=True)
def paired_cosine_distances(X, Y): # -> Any:
    """
...
def paired_distances(X, Y, *, metric=..., **kwds): # -> Any | NDArray[float64] | None:
    """
...
def additive_chi2_kernel(X, Y=...): # -> NDArray[float64] | Any:
...
def chi2_kernel(X, Y=..., gamma=...): # -> NDArray[Any] | Any:
...
def distance_metrics(): # -> dict[str, Callable[..., NDArray[float64] | NDArray[floating[Any]]] | Callable[..., Any] | None]:
...
def pairwise_distances_chunked(X, Y=..., *, reduce_func=..., metric=..., n_jobs=..., working_memory=..., **kwds): # -> Generator[Any | NDArray[Any] | NDArray[floating[Any]] | NDArray[float64], Any, None]:
...
def pairwise_distances(X, Y=..., metric=..., *, n_jobs=..., force_all_finite=..., ensure_all_finite=..., **kwds): # -> NDArray[Any] | NDArray[floating[Any]] | Any | NDArray[float64]:
...
def kernel_metrics(): # -> dict[str, Callable[..., NDArray[float64] | Any] | Callable[..., NDArray[Any] | Any] | Callable[..., Any]]:
...
def pairwise_kernels(X, Y=..., metric=..., *, filter_params=..., n_jobs=..., **kwds): # -> NDArray[Any] | Any | NDArray[float64] | None:
