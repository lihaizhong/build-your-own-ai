...
@validate_params({ "X": ["array-like", "sparse matrix"],"labels": ["array-like"],"metric": [StrOptions(set(_VALID_METRICS) | "precomputed"), callable],"sample_size": [Interval(Integral, 1, None, closed="left"), None],"random_state": ["random_state"] }, prefer_skip_nested_validation=True)
def silhouette_score(X, labels, *, metric=..., sample_size=..., random_state=..., **kwds): # -> float:
...
@validate_params({ "X": ["array-like", "sparse matrix"],"labels": ["array-like"],"metric": [StrOptions(set(_VALID_METRICS) | "precomputed"), callable] }, prefer_skip_nested_validation=True)
def silhouette_samples(X, labels, *, metric=..., **kwds):
