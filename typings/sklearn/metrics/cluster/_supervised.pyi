...
better.
"""
def check_clusterings(labels_true, labels_pred): # -> tuple[Any, Any]:
...
def contingency_matrix(labels_true, labels_pred, *, eps=..., sparse=..., dtype=...): # -> csr_array | ndarray[Any, dtype[float64]]:
...
def pair_confusion_matrix(labels_true, labels_pred): # -> NDArray[signedinteger[_64Bit]]:
...
@validate_params({ "labels_true": ["array-like"],"labels_pred": ["array-like"] }, prefer_skip_nested_validation=True)
def rand_score(labels_true, labels_pred): # -> float:
    """Rand index.
...
def homogeneity_completeness_v_measure(labels_true, labels_pred, *, beta=...): # -> tuple[float, float, float]:
...
def mutual_info_score(labels_true, labels_pred, *, contingency=...): # -> float:
...
def adjusted_mutual_info_score(labels_true, labels_pred, *, average_method=...): # -> float:
...
@validate_params({ "labels_true": ["array-like"],"labels_pred": ["array-like"],"average_method": [StrOptions("arithmetic", "max", "min", "geometric")] }, prefer_skip_nested_validation=True)
def normalized_mutual_info_score(labels_true, labels_pred, *, average_method=...): # -> float:
...
@validate_params({ "labels_true": ["array-like"],"labels_pred": ["array-like"],"sparse": ["boolean", Hidden(StrOptions("deprecated"))] }, prefer_skip_nested_validation=True)
def fowlkes_mallows_score(labels_true, labels_pred, *, sparse=...): # -> float:
