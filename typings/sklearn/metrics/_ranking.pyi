...
def average_precision_score(y_true, y_score, *, average=..., pos_label=..., sample_weight=...): # -> float | NDArray[float64] | Literal[0]:
...
def det_curve(y_true, y_score, pos_label=..., sample_weight=..., drop_intermediate=...): # -> tuple[Any, Any, ndarray[Any, dtype[Any]]]:
...
def roc_auc_score(y_true, y_score, *, average=..., sample_weight=..., max_fpr=..., multi_class=..., labels=...): # -> floating[Any] | float | NDArray[float64] | Literal[0]:
...
@validate_params({ "y_true": ["array-like"],"y_score": ["array-like"],"pos_label": [Real, str, "boolean", None],"sample_weight": ["array-like", None],"drop_intermediate": ["boolean"] }, prefer_skip_nested_validation=True)
def precision_recall_curve(y_true, y_score, *, pos_label=..., sample_weight=..., drop_intermediate=...): # -> tuple[NDArray[Any], NDArray[Any], Any]:
...
@validate_params({ "y_true": ["array-like"],"y_score": ["array-like"],"pos_label": [Real, str, "boolean", None],"sample_weight": ["array-like", None],"drop_intermediate": ["boolean"] }, prefer_skip_nested_validation=True)
def roc_curve(y_true, y_score, *, pos_label=..., sample_weight=..., drop_intermediate=...): # -> tuple[NDArray[Any] | Any, NDArray[Any] | Any, Any]:
...
def label_ranking_average_precision_score(y_true, y_score, *, sample_weight=...): # -> float:
...
def coverage_error(y_true, y_score, *, sample_weight=...): # -> float:
...
@validate_params({ "y_true": ["array-like", "sparse matrix"],"y_score": ["array-like"],"sample_weight": ["array-like", None] }, prefer_skip_nested_validation=True)
def label_ranking_loss(y_true, y_score, *, sample_weight=...): # -> float:
...
def dcg_score(y_true, y_score, *, k=..., log_base=..., sample_weight=..., ignore_ties=...): # -> float:
...
def ndcg_score(y_true, y_score, *, k=..., sample_weight=..., ignore_ties=...): # -> float:
...
def top_k_accuracy_score(y_true, y_score, *, k=..., normalize=..., sample_weight=..., labels=...): # -> float:
