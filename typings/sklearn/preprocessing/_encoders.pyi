...
class _BaseEncoder(TransformerMixin, BaseEstimator):
    ...
    """
    @property
    def infrequent_categories_(self): # -> list[Any | None]:
...
class OneHotEncoder(_BaseEncoder):
    ...
    def __init__(self, *, categories=..., drop=..., sparse_output=..., dtype=..., handle_unknown=..., min_frequency=..., max_categories=..., feature_name_combiner=...) -> None:
        ...
    ...
    def inverse_transform(self, X): # -> NDArray[Any]:
        """
...
class OrdinalEncoder(OneToOneFeatureMixin, _BaseEncoder):
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, *, categories=..., dtype=..., handle_unknown=..., unknown_value=..., encoded_missing_value=..., min_frequency=..., max_categories=...) -> None:
        ...
    ...
    def transform(self, X): # -> NDArray[floating[_64Bit]]:
        """
