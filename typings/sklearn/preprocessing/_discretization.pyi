...
class KBinsDiscretizer(TransformerMixin, BaseEstimator):
    ...
    def __init__(self, n_bins=..., *, encode=..., strategy=..., quantile_method=..., dtype=..., subsample=..., random_state=...) -> None:
        ...
    ...
    def transform(self, X): # -> str | tuple[str, str] | Any | tuple[Any, Any] | NDArray[float64] | csr_matrix:
        """
        Discretize the data.
