...
__all__ = ["LabelBinarizer", "LabelEncoder", "MultiLabelBinarizer", "label_binarize"]
class LabelEncoder(TransformerMixin, BaseEstimator, auto_wrap_output_keys=None):
    ...
    def fit_transform(self, y): # -> Any | NDArray[Any] | None:
    ...
    def inverse_transform(self, y): # -> Any:
...
class LabelBinarizer(TransformerMixin, BaseEstimator, auto_wrap_output_keys=None):
    ...
    def fit_transform(self, y): # -> csr_matrix | NDArray[unsignedinteger[Any]] | ndarray[Any, dtype[Any]]:
    ...
    def transform(self, y): # -> csr_matrix | NDArray[unsignedinteger[Any]] | ndarray[Any, dtype[Any]]:
    ...
    def inverse_transform(self, Y, threshold=...): # -> csr_matrix | ndarray[Any, dtype[Any]] | NDArray[Any]:
...
@validate_params({ "y": ["array-like", "sparse matrix"],"classes": ["array-like"],"neg_label": [Interval(Integral, None, None, closed="neither")],"pos_label": [Interval(Integral, None, None, closed="neither")],"sparse_output": ["boolean"] }, prefer_skip_nested_validation=True)
def label_binarize(y, *, classes, neg_label=..., pos_label=..., sparse_output=...): # -> csr_matrix | NDArray[unsignedinteger[Any]] | ndarray[Any, dtype[Any]]:
    """Binarize labels in a one-vs-all fashion.
...
class MultiLabelBinarizer(TransformerMixin, BaseEstimator, auto_wrap_output_keys=None):
    ...
    @_fit_context(prefer_skip_nested_validation=True)
    def fit_transform(self, y): # -> NDArray[float64] | csr_matrix:
    ...
    def transform(self, y): # -> NDArray[float64] | csr_matrix:
    ...
    def inverse_transform(self, yt): # -> list[tuple[Any, ...]]:
