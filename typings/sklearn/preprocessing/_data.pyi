...
BOUNDS_THRESHOLD = ...
__all__ = ["Binarizer", "KernelCenterer", "MaxAbsScaler", "MinMaxScaler", "Normalizer", "OneHotEncoder", "PowerTransformer", "QuantileTransformer", "RobustScaler", "StandardScaler", "add_dummy_feature", "binarize", "maxabs_scale", "minmax_scale", "normalize", "power_transform", "quantile_transform", "robust_scale", "scale"]
...
class StandardScaler(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X, copy=...): # -> str | tuple[str, str] | Any | tuple[Any, Any]:
...
class MaxAbsScaler(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X): # -> str | tuple[str, str] | Any | tuple[Any, Any] | NDArray[Any]:
        """Scale the data.
...
class RobustScaler(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X): # -> str | tuple[str, str] | Any | tuple[Any, Any] | NDArray[floating[Any]] | NDArray[complexfloating[Any, Any]]:
...
def normalize(X, norm=..., *, axis=..., copy=..., return_norm=...): # -> tuple[Any, Any | NDArray[Any] | float | generic | bool | int | complex | str | bytes | memoryview[int]]:
...
class Normalizer(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X, copy=...): # -> tuple[Any, Any | NDArray[Any] | float | generic | bool | int | complex | str | bytes | memoryview[int]]:
...
class QuantileTransformer(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X): # -> str | tuple[str, str] | Any | tuple[Any, Any]:
    ...
    def inverse_transform(self, X): # -> str | tuple[str, str] | Any | tuple[Any, Any]:
...
class PowerTransformer(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    @_fit_context(prefer_skip_nested_validation=True)
    def fit_transform(self, X, y=...): # -> Any | str | tuple[str, str] | tuple[Any, Any]:
...
def power_transform(X, method=..., *, standardize=..., copy=...): # -> Any | str | tuple[str, str] | tuple[Any, Any]:
