...
class PolynomialFeatures(TransformerMixin, BaseEstimator):
    ...
    def transform(self, X): # -> csr_matrix | csr_array | Any | csc_matrix | csc_array | coo_matrix | coo_array:
...
class SplineTransformer(TransformerMixin, BaseEstimator):
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, n_knots=..., degree=..., *, knots=..., extrapolation=..., include_bias=..., order=..., sparse_output=...) -> None:
        ...
