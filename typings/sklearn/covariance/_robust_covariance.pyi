...
"""
def c_step(X, n_support, remaining_iterations=..., initial_estimates=..., verbose=..., cov_computation_method=..., random_state=...): # -> tuple[Any, Any, Any | float, NDArray[Any], Any | float]:
...
def select_candidates(X, n_support, n_trials, select=..., n_iter=..., verbose=..., cov_computation_method=..., random_state=...): # -> tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
...
def fast_mcd(X, support_fraction=..., cov_computation_method=..., random_state=...): # -> tuple[Any | NDArray[Any], Any | NDArray[floating[Any]], NDArray[Any] | Any, NDArray[float64] | Any]:
...
class MinCovDet(EmpiricalCovariance):
    ...
    def reweight_covariance(self, data): # -> tuple[NDArray[float64] | Any, NDArray[Any] | Any, NDArray[Any]]:
