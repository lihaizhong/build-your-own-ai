...
def empirical_covariance(X, *, assume_centered=...): # -> NDArray[Any] | Any:
...
class EmpiricalCovariance(BaseEstimator):
    ...
    def get_precision(self): # -> tuple[Any, int] | None:
    ...
    def error_norm(self, comp_cov, norm=..., scaling=..., squared=...): # -> float64 | Any:
    ...
    def mahalanobis(self, X): # -> NDArray[floating[Any]]:
