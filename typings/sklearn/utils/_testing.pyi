...
"""Testing utilities."""
__all__ = ["SkipTest", "assert_allclose", "assert_almost_equal", "assert_array_almost_equal", "assert_array_equal", "assert_array_less", "assert_run_python_script_without_output"]
SkipTest = unittest.case.SkipTest
def ignore_warnings(obj=..., category=...): # -> _Wrapped[..., Any, ..., Any] | _IgnoreWarnings:
...
class _IgnoreWarnings:
    ...
    def __call__(self, fn): # -> _Wrapped[..., Any, ..., Any]:
...
def assert_docstring_consistency(objects, include_params=..., exclude_params=..., include_attrs=..., exclude_attrs=..., include_returns=..., exclude_returns=..., descr_regex_pattern=..., ignore_types=...): # -> None:
...
class MinimalClassifier:
    ...
    * within a `SearchCV` in `test_search.py`.
    ...
    def predict_proba(self, X): # -> NDArray[floating[_64Bit]]:
        ...
