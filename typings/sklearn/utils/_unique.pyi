...
def attach_unique(*ys, return_tuple=...): # -> ndarray[tuple[int, ...], dtype[Any]] | NDArray[Any] | tuple[Any | ndarray[tuple[int, ...], dtype[Any]] | NDArray[Any], ...] | tuple[Any | ndarray[tuple[int, ...], dtype[Any]] | NDArray[Any]]:
...
def cached_unique(*ys, xp=...): # -> Any | tuple[Any, ...]:
