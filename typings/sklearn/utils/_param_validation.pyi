...
def validate_params(parameter_constraints, *, prefer_skip_nested_validation): # -> Callable[..., _Wrapped[..., Any, ..., Any]]:
...
class _PandasNAConstraint(_Constraint):
    ...
    def is_satisfied_by(self, val): # -> TypeIs[NaTType | NAType | None] | Literal[False]:
        ...
