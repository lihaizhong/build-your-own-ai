...
def min_max_axis(X, axis, ignore_nan=...): # -> tuple[Any | ndarray[Any, dtype[float64]], Any | ndarray[Any, dtype[float64]]] | None:
...
def count_nonzero(X, axis=..., sample_weight=...): # -> Any | NDArray[Any] | NDArray[intp]:
