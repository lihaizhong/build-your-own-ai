...
def get_namespace(*arrays, remove_none=..., remove_types=..., xp=...): # -> tuple[Any, Literal[False]] | tuple[ModuleType, Literal[False]] | tuple[Any, Literal[True]] | tuple[ModuleType, Literal[True]]:
