...
def as_float_array(X, *, copy=..., force_all_finite=..., ensure_all_finite=...): # -> ndarray[tuple[int, ...], dtype[Any]] | NDArray[floating[_32Bit] | floating[_64Bit]]:
...
def check_X_y(X, y, accept_sparse=..., *, accept_large_sparse=..., dtype=..., order=..., copy=..., force_writeable=..., force_all_finite=..., ensure_all_finite=..., ensure_2d=..., allow_nd=..., multi_output=..., ensure_min_samples=..., ensure_min_features=..., y_numeric=..., estimator=...): # -> tuple[Any, Any]:
...
def column_or_1d(y, *, dtype=..., warn=..., device=...): # -> Any:
...
def validate_data(_estimator, /, X=..., y=..., reset=..., validate_separately=..., skip_check_array=..., **check_params): # -> str | tuple[str, str] | Any | tuple[Any, Any]:
