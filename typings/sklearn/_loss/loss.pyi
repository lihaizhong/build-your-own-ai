...
class BaseLoss:
    ...
    def loss_gradient(self, y_true, raw_prediction, sample_weight=..., loss_out=..., gradient_out=..., n_threads=...): # -> tuple[Any, Any]:
    ...
    def gradient_hessian(self, y_true, raw_prediction, sample_weight=..., gradient_out=..., hessian_out=..., n_threads=...): # -> tuple[Any, Any]:
    ...
    def init_gradient_and_hessian(self, n_samples, dtype=..., order=...): # -> tuple[Any, NDArray[floating[_64Bit]] | Any]:
...
class AbsoluteError(BaseLoss):
    ...
    def fit_intercept_only(self, y_true, sample_weight=...): # -> Any:
        """Compute raw_prediction of an intercept-only model.
...
class HuberLoss(BaseLoss):
    ...
    differentiable = ...
    need_update_leaves_values = ...
    def __init__(self, sample_weight=..., quantile=..., delta=...) -> None:
        ...
...
class HalfBinomialLoss(BaseLoss):
    ...
    def predict_proba(self, raw_prediction): # -> NDArray[float64]:
...
class HalfMultinomialLoss(BaseLoss):
    ...
    def in_y_true_range(self, y): # -> bool | Literal[False]:
        """Return True if y is in the valid range of y_true.
    ...
    def gradient_proba(self, y_true, raw_prediction, sample_weight=..., gradient_out=..., proba_out=..., n_threads=...): # -> tuple[Any, Any]:
