...
def fastica(X, n_components=..., *, algorithm=..., whiten=..., fun=..., fun_args=..., max_iter=..., tol=..., w_init=..., whiten_solver=..., random_state=..., return_X_mean=..., compute_sources=..., return_n_iter=...): # -> list[Any | NDArray[float64] | NDArray[Any] | NDArray[floating[_32Bit] | floating[_64Bit]] | None]:
...
class FastICA(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def __init__(self, n_components=..., *, algorithm=..., whiten=..., fun=..., fun_args=..., max_iter=..., tol=..., w_init=..., whiten_solver=..., random_state=...) -> None:
        ...
    ...
    def inverse_transform(self, X, copy=...): # -> Any:
