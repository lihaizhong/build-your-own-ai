...
class _BaseSparsePCA(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def __init__(self, n_components=..., *, alpha=..., ridge_alpha=..., max_iter=..., tol=..., method=..., n_jobs=..., verbose=..., random_state=...) -> None:
        ...
...
class MiniBatchSparsePCA(_BaseSparsePCA):
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, n_components=..., *, alpha=..., ridge_alpha=..., max_iter=..., callback=..., batch_size=..., verbose=..., shuffle=..., n_jobs=..., method=..., random_state=..., tol=..., max_no_improvement=...) -> None:
        ...
