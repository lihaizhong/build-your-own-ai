...
def sparse_encode(X, dictionary, *, gram=..., cov=..., algorithm=..., n_nonzero_coefs=..., alpha=..., copy_cov=..., init=..., max_iter=..., n_jobs=..., check_input=..., verbose=..., positive=...): # -> ndarray[Any, dtype[float64]] | ndarray[Any, dtype[Any]] | Any:
    """Sparse coding.
...
def dict_learning_online(X, n_components=..., *, alpha=..., max_iter=..., return_code=..., dict_init=..., callback=..., batch_size=..., verbose=..., shuffle=..., n_jobs=..., method=..., random_state=..., positive_dict=..., positive_code=..., method_max_iter=..., tol=..., max_no_improvement=...): # -> tuple[NDArray[float64] | ndarray[Any, dtype[Any]] | Any, Any]:
...
class _BaseSparseCoding(ClassNamePrefixFeaturesOutMixin, TransformerMixin):
    ...
    def transform(self, X): # -> NDArray[float64] | ndarray[Any, dtype[Any]] | Any:
...
class SparseCoder(_BaseSparseCoding, BaseEstimator):
    ...
    def transform(self, X, y=...): # -> NDArray[float64] | ndarray[Any, dtype[Any]] | Any:
        """Encode the data as a sparse combination of the dictionary atoms.
...
class DictionaryLearning(_BaseSparseCoding, BaseEstimator):
    ...
    def fit_transform(self, X, y=...): # -> ndarray[Any, dtype[float64]] | ndarray[Any, dtype[Any]] | Any:
