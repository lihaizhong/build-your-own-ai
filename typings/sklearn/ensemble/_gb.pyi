...
class BaseGradientBoosting(BaseEnsemble, metaclass=ABCMeta):
    ...
    @property
    def feature_importances_(self): # -> NDArray[floating[_64Bit]] | Any:
    ...
    def apply(self, X): # -> NDArray[float64]:
...
class GradientBoostingClassifier(ClassifierMixin, BaseGradientBoosting):
    ...
    def decision_function(self, X): # -> ndarray[Any, dtype[floating[_64Bit]]]:
    ...
    def staged_decision_function(self, X): # -> Generator[NDArray[floating[_64Bit]] | Any, Any, None]:
    ...
    def predict(self, X): # -> ndarray[Any, dtype[Any]] | Any | None:
        """Predict class for X.
    ...
    def staged_predict(self, X): # -> Generator[ndarray[Any, dtype[Any]] | Any, Any, None]:
...
class GradientBoostingRegressor(RegressorMixin, BaseGradientBoosting):
    ...
    def predict(self, X): # -> ndarray[Any, dtype[floating[_64Bit]]]:
    ...
    def staged_predict(self, X): # -> Generator[ndarray[Any, dtype[floating[_64Bit]]] | Any, Any, None]:
    ...
    def apply(self, X): # -> ndarray[Any, dtype[float64]]:
        """Apply trees in the ensemble to X, return leaf indices.
