...
class BaseWeightBoosting(BaseEnsemble, metaclass=ABCMeta):
    ...
    @abstractmethod
    def __init__(self, estimator=..., *, n_estimators=..., estimator_params=..., learning_rate=..., random_state=...) -> None:
        ...
    ...
    def staged_score(self, X, y, sample_weight=...): # -> Generator[float | Any, Any, None]:
...
class AdaBoostClassifier(_RoutingNotSupportedMixin, ClassifierMixin, BaseWeightBoosting):
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, estimator=..., *, n_estimators=..., learning_rate=..., algorithm=..., random_state=...) -> None:
        ...
    ...
    def staged_predict(self, X): # -> Generator[NDArray[Any], Any, None]:
    ...
    def decision_function(self, X): # -> NDArray[Any] | Any:
    ...
    def predict_proba(self, X): # -> NDArray[float64] | Any:
...
class AdaBoostRegressor(_RoutingNotSupportedMixin, RegressorMixin, BaseWeightBoosting):
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, estimator=..., *, n_estimators=..., learning_rate=..., loss=..., random_state=...) -> None:
        ...
    
    def predict(self, X): # -> ndarray[Any, dtype[Any]]:
    ...
    def staged_predict(self, X): # -> Generator[ndarray[Any, dtype[Any]], Any, None]:
        """Return staged predictions for X.
