...
def compute_optics_graph(X, *, min_samples, max_eps, metric, p, metric_params, algorithm, leaf_size, n_jobs): # -> tuple[NDArray[Any], NDArray[float64], NDArray[float64], NDArray[Any]]:
...
def cluster_optics_dbscan(*, reachability, core_distances, ordering, eps): # -> NDArray[Any]:
...
def cluster_optics_xi(*, reachability, predecessor, ordering, min_samples, min_cluster_size=..., xi=..., predecessor_correction=...): # -> tuple[NDArray[Any], NDArray[Any]]:
