...
class BaseSpectral(BiclusterMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    @abstractmethod
    def __init__(self, n_clusters=..., svd_method=..., n_svd_vecs=..., mini_batch=..., init=..., n_init=..., random_state=...) -> None:
        ...
...
class SpectralBiclustering(BaseSpectral):
    ...
    * :doi:`Kluger, Yuval, et. al., 2003. Spectral biclustering of microarray
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, n_clusters=..., *, method=..., n_components=..., n_best=..., svd_method=..., n_svd_vecs=..., mini_batch=..., init=..., n_init=..., random_state=...) -> None:
        ...
