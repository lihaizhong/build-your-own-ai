...
def affinity_propagation(S, *, preference=..., convergence_iter=..., max_iter=..., damping=..., copy=..., verbose=..., return_n_iter=..., random_state=...): # -> tuple[NDArray[signedinteger[Any]] | NDArray[Any] | list[Any], NDArray[signedinteger[Any]] | NDArray[Any], int] | tuple[NDArray[signedinteger[Any]] | NDArray[Any] | list[Any], NDArray[signedinteger[Any]] | NDArray[Any]]:
...
class AffinityPropagation(ClusterMixin, BaseEstimator):
    ...
    def predict(self, X): # -> NDArray[float64] | NDArray[Any]:
