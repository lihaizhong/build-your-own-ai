...
def dbscan(X, eps=..., *, min_samples=..., metric=..., metric_params=..., algorithm=..., leaf_size=..., p=..., sample_weight=..., n_jobs=...): # -> tuple[NDArray[intp], NDArray[signedinteger[_NBitIntP]]]:
...
class DBSCAN(ClusterMixin, BaseEstimator):
    ...
    def fit_predict(self, X, y=..., sample_weight=...): # -> NDArray[signedinteger[_NBitIntP]]:
