...
def kmeans_plusplus(X, n_clusters, *, sample_weight=..., x_squared_norms=..., random_state=..., n_local_trials=...): # -> tuple[NDArray[float64], NDArray[Any]]:
...
def k_means(X, n_clusters, *, sample_weight=..., init=..., n_init=..., max_iter=..., verbose=..., tol=..., random_state=..., copy_x=..., algorithm=..., return_n_iter=...): # -> tuple[Any, NDArray[signedinteger[_32Bit]] | None, Any | None, int] | tuple[Any, NDArray[signedinteger[_32Bit]] | None, Any | None]:
...
class _BaseKMeans(ClassNamePrefixFeaturesOutMixin, TransformerMixin, ClusterMixin, BaseEstimator, ABC):
    ...
    def predict(self, X): # -> tuple[NDArray[signedinteger[_32Bit]], Any] | NDArray[signedinteger[_32Bit]]:
