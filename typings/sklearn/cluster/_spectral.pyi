...
def discretize(vectors, *, copy=..., max_svd_restarts=..., n_iter_max=..., random_state=...): # -> Any:
...
def spectral_clustering(affinity, *, n_clusters=..., n_components=..., eigen_solver=..., random_state=..., n_init=..., eigen_tol=..., assign_labels=..., verbose=...): # -> NDArray[signedinteger[_32Bit]] | Any | None:
