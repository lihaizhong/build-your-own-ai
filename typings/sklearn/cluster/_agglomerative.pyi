...
def ward_tree(X, *, connectivity=..., n_clusters=..., return_distance=...): # -> tuple[Any, Literal[1], Any, None, Any] | tuple[Any, Literal[1], Any, None] | tuple[NDArray[Any], Any, Any, NDArray[signedinteger[_NBitIntP]], NDArray[Any]] | tuple[NDArray[Any], Any, Any, NDArray[signedinteger[_NBitIntP]]]:
...
def linkage_tree(X, connectivity=..., n_clusters=..., linkage=..., affinity=..., return_distance=...): # -> tuple[Any, Literal[1], Any, None, Any] | tuple[Any, Literal[1], Any, None] | tuple[Any, Any, Any, NDArray[signedinteger[_NBitIntP]], Any] | tuple[Any, Any, Any, NDArray[signedinteger[_NBitIntP]]] | tuple[ndarray[Any, dtype[Any]], Any, Any, NDArray[signedinteger[_NBitIntP]], NDArray[float64] | Any | None] | tuple[ndarray[Any, dtype[Any]], Any, Any, NDArray[signedinteger[_NBitIntP]]]:
