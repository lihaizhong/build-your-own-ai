...
class _BaseImputer(TransformerMixin, BaseEstimator):
    ...
    def __init__(self, *, missing_values=..., add_indicator=..., keep_empty_features=...) -> None:
        ...
...
class SimpleImputer(_BaseImputer):
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, *, missing_values=..., strategy=..., fill_value=..., copy=..., add_indicator=..., keep_empty_features=...) -> None:
        ...
    ...
    def transform(self, X): # -> csr_matrix | csc_matrix | csr_array | csc_array | coo_matrix | Any | coo_array | NDArray[Any]:
    ...
    def inverse_transform(self, X): # -> NDArray[float64]:
...
class MissingIndicator(TransformerMixin, BaseEstimator):
    ...
    def transform(self, X): # -> ndarray[Any, dtype[float64]] | Any | csc_matrix | csc_array | ndarray[Any, dtype[Any]] | csr_matrix:
    ...
    @_fit_context(prefer_skip_nested_validation=True)
    def fit_transform(self, X, y=...): # -> ndarray[Any, dtype[float64]] | Any | csc_matrix | csc_array | ndarray[Any, dtype[Any]] | csr_matrix:
        """Generate missing values indicator for `X`.
