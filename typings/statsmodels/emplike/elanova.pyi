...
class ANOVA(_ANOVAOpt):
    ...
    def compute_ANOVA(self, mu=..., mu_start=..., return_weights=...): # -> tuple[Any, NDArray[signedinteger[Any]], Any, Any] | tuple[Any, NDArray[signedinteger[Any]], Any] | tuple[Any, NDArray[signedinteger[Any]], float, Any] | tuple[Any, NDArray[signedinteger[Any]], float]:
        """
