...
class OriginResults(RegressionResults):
    ...
    def el_test(self, b0_vals, param_nums, method=..., stochastic_exog=..., return_weights=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any] | tuple[Any, ndarray[Any, dtype[Any]]]:
        """
    ...
    def conf_int_el(self, param_num, upper_bound=..., lower_bound=..., sig=..., method=..., stochastic_exog=...): # -> tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any]:
        """
