...
class DescStatUV(_OptFuncts):
    ...
    def test_mean(self, mu0, return_weights=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any] | tuple[Any, ndarray[Any, dtype[Any]]]:
        """
    ...
    def ci_mean(self, sig=..., method=..., epsilon=..., gamma_low=..., gamma_high=...): # -> tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any] | tuple[Any, Any] | None:
        """
    ...
    def test_var(self, sig2_0, return_weights=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any] | tuple[Any, ndarray[Any, dtype[Any]]]:
        """
    ...
    def ci_var(self, lower_bound=..., upper_bound=..., sig=...): # -> tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any]:
        """
    ...
    def test_skew(self, skew0, return_weights=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any] | tuple[Any, ndarray[Any, dtype[Any]]]:
        """
    ...
    def test_kurt(self, kurt0, return_weights=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any] | tuple[Any, ndarray[Any, dtype[Any]]]:
        """
    ...
    def test_joint_skew_kurt(self, skew0, kurt0, return_weights=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any] | tuple[Any, ndarray[Any, dtype[Any]]]:
        """
    ...
    def ci_skew(self, sig=..., upper_bound=..., lower_bound=...): # -> tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any]:
        """
    ...
    def ci_kurt(self, sig=..., upper_bound=..., lower_bound=...): # -> tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any]:
        """
...
class DescStatMV(_OptFuncts):
    ...
    def mv_test_mean(self, mu_array, return_weights=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any] | tuple[Any, ndarray[Any, dtype[Any]]]:
        """
    ...
    def test_corr(self, corr0, return_weights=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any] | tuple[Any, ndarray[Any, dtype[Any]]]:
        """
    ...
    def ci_corr(self, sig=..., upper_bound=..., lower_bound=...): # -> tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any]:
        """
