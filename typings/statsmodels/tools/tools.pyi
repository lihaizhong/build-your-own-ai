...
def drop_missing(Y, X=..., axis=...): # -> tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]] | ndarray[Any, dtype[Any]]:
    """
...
def categorical(data, col=..., dictnames=..., drop=...): # -> tuple[DataFrame, dict[int, Any]] | DataFrame | tuple[NDArray[Any], dict[Any, Any]] | NDArray[Any] | tuple[Any, dict[Any, Any]] | Any:
    """
...
def add_constant(data, prepend=..., has_constant=...): # -> DataFrame | NDArray[floating[Any]] | ndarray[Any, dtype[Any]] | NDArray[float64]:
    """
...
def recipr(x): # -> NDArray[floating[_64Bit]]:
    """
...
def recipr0(x): # -> NDArray[floating[_64Bit]]:
    """
...
def fullrank(x, r=...): # -> NDArray[floating[_64Bit]]:
    """
