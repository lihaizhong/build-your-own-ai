...
def array_like(obj, name, dtype=..., ndim=..., maxdim=..., shape=..., order=..., contiguous=..., optional=...): # -> NDArray[floating[_NBitDouble]] | None:
    """
...
class PandasWrapper:
    ...
    def wrap(self, obj, columns=..., append=..., trim_start=..., trim_end=...): # -> NDArray[Any] | Series[float] | DataFrame:
        """
        Parameters
        ----------
        obj : {array_like}
...
def dict_like(value, name, optional=..., strict=...): # -> Mapping[Any, object] | dict[Any, object] | None:
    """
