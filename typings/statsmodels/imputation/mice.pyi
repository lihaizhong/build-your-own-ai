...
class MICEData:
    ...
    def get_split_data(self, vname): # -> tuple[NDArray[Any], NDArray[Any], NDArray[Any], Any | dict[Any, Any], Any | dict[Any, Any]]:
        """
    ...
    def get_fitting_data(self, vname): # -> tuple[NDArray[Any], NDArray[Any], dict[Any, Any], dict[Any, Any]]:
        """
