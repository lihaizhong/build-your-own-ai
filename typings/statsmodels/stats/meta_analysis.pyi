...
class CombineResults:
    ...
    def conf_int_samples(self, alpha=..., use_t=..., nobs=..., ci_func=...): # -> tuple[Any, Any]:
    ...
    def conf_int(self, alpha=..., use_t=...): # -> tuple[Any, Any, Any, Any]:
    ...
    def summary_array(self, alpha=..., use_t=...): # -> tuple[NDArray[Any], list[str]]:
    ...
    def plot_forest(self, alpha=..., use_t=..., use_exp=..., ax=..., **kwds):
...
def effectsize_smd(mean1, sd1, nobs1, mean2, sd2, nobs2): # -> tuple[Any, Any]:
...
def effectsize_2proportions(count1, nobs1, count2, nobs2, statistic=..., zero_correction=..., zero_kwds=...): # -> tuple[Any, Any]:
