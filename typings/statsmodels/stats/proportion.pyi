...
License: BSD-3
"""
def proportion_confint(count, nobs, alpha=..., method=...): # -> tuple[DataFrame | Series[Any] | Any | NDArray[floating[Any]] | tuple[Any, RootResults] | ndarray[Any, dtype[Any]] | Literal[0], DataFrame | Series[Any] | Any | NDArray[floating[Any]] | tuple[Any, RootResults] | ndarray[Any, dtype[Any]] | Literal[1]]:
...
def binom_tost(count, nobs, low, upp): # -> tuple[NDArray[Any], ndarray[Any, dtype[Any]] | float | Any, ndarray[Any, dtype[Any]] | float | Any]:
...
def binom_tost_reject_interval(low, upp, nobs, alpha=...): # -> tuple[NDArray[signedinteger[Any]], NDArray[signedinteger[Any]]]:
...
def binom_test_reject_interval(value, nobs, alpha=..., alternative=...): # -> tuple[NDArray[signedinteger[Any]] | Literal[0], NDArray[signedinteger[Any]] | Any]:
...
def binom_test(count, nobs, prop=..., alternative=...): # -> ndarray[Any, dtype[Any]] | float:
...
def proportions_ztest(count, nobs, value=..., alternative=..., prop_var=...): # -> tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]]:
    """
...
def proportions_ztost(count, nobs, low, upp, prop_var=...): # -> tuple[NDArray[Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]]]:
...
def confint_proportions_2indep(count1, nobs1, count2, nobs2, method=..., compare=..., alpha=..., correction=...): # -> tuple[Any, Any]:
...
def score_test_proportions_2indep(count1, nobs1, count2, nobs2, value=..., compare=..., alternative=..., correction=..., return_results=...): # -> HolderTuple | tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]]:
...
def test_proportions_2indep(count1, nobs1, count2, nobs2, value=..., method=..., compare=..., alternative=..., correction=..., return_results=...): # -> HolderTuple | tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]] | tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]] | Any]:
...
def power_proportions_2indep(diff, prop2, nobs1, ratio=..., alpha=..., value=..., alternative=..., return_results=...): # -> Holder | NDArray[Any] | NDArray[signedinteger[Any]] | Literal[0]:
