...
_alias_list = ...
multitest_alias = ...
def multipletests(pvals, alpha=..., method=..., is_sorted=..., returnsorted=...): # -> tuple[NDArray[bool] | Any, NDArray[floating[Any]] | NDArray[Any] | Any, Any, float]:
    """
...
def fdrcorrection(pvals, alpha=..., method=..., is_sorted=...): # -> tuple[NDArray[bool], ndarray[Any, dtype[Any]]]:
    '''
