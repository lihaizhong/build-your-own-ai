...
def compare_cox(results_x, results_z, store=...): # -> tuple[Any, NDArray[signedinteger[Any]], ResultsStore] | tuple[Any, NDArray[signedinteger[Any]]]:
    """
...
def acorr_ljungbox(x, lags=..., boxpierce=..., model_df=..., period=..., return_df=..., auto_lag=...): # -> DataFrame | tuple[Any, Any] | tuple[Any, Any, Any, Any]:
    """
...
def acorr_lm(resid, nlags=..., autolag=..., store=..., *, period=..., ddof=..., cov_type=..., cov_kwargs=...): # -> tuple[Any | float, ndarray[Any, dtype[Any]] | float, float, float, ResultsStore] | tuple[Any | float, ndarray[Any, dtype[Any]] | float, float, float]:
    """
...
@deprecate_kwarg("maxlag", "nlags")
def het_arch(resid, nlags=..., autolag=..., store=..., ddof=...): # -> tuple[Any | float, ndarray[Any, dtype[Any]] | float, float, float, ResultsStore] | tuple[Any | float, ndarray[Any, dtype[Any]] | float, float, float]:
    """
...
def acorr_breusch_godfrey(res, nlags=..., store=...): # -> tuple[Any, ndarray[Any, dtype[Any]], float, float, ResultsStore] | tuple[Any, ndarray[Any, dtype[Any]], float, float]:
    """
...
def het_breuschpagan(resid, exog_het, robust=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any, Any]:
    r"""
...
def het_white(resid, exog): # -> tuple[Any, ndarray[Any, dtype[Any]], Any, Any]:
    """
...
def het_goldfeldquandt(y, x, idx=..., split=..., drop=..., alternative=..., store=...): # -> tuple[Any, ndarray[Any, dtype[Any]] | NDArray[signedinteger[Any]], Literal['increasing', 'decreasing', 'two-sided'], ResultsStore] | tuple[Any, ndarray[Any, dtype[Any]] | NDArray[signedinteger[Any]], Literal['increasing', 'decreasing', 'two-sided']]:
    """
...
def linear_rainbow(res, frac=..., order_by=..., use_distance=..., center=...): # -> tuple[Any, ndarray[Any, dtype[Any]]]:
    """
...
def linear_lm(resid, exog, func=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any]:
    """
...
def spec_white(resid, exog): # -> tuple[Any, ndarray[Any, dtype[Any]], Any]:
    """
...
def breaks_cusumolsresid(resid, ddof=...): # -> tuple[Any, ndarray[Any, dtype[Any]], list[tuple[int, float]]]:
    """
