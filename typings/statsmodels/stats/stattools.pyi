...
def omni_normtest(resids, axis=...): # -> tuple[float, float] | NormaltestResult:
    """
...
def jarque_bera(resids, axis=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any | ndarray[Any, dtype[Any]], Any | NDArray[signedinteger[Any]]]:
    r"""
...
def robust_skewness(y, axis=...): # -> tuple[Any | ndarray[Any, dtype[Any]], Any, Any, Any]:
    """
...
def robust_kurtosis(y, axis=..., ab=..., dg=..., excess=...): # -> tuple[Any, Any, Any, Any]:
    """
...
def medcouple(y, axis=...): # -> floating[Any] | NDArray[floating[Any]]:
    """
