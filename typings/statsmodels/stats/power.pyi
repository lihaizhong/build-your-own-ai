...
def normal_power(effect_size, nobs, alpha, alternative=..., sigma=...): # -> NDArray[Any] | NDArray[signedinteger[Any]] | Literal[0]:
...
def normal_power_het(diff, nobs, alpha, std_null=..., std_alternative=..., alternative=...): # -> NDArray[Any] | NDArray[signedinteger[Any]] | Literal[0]:
    """Calculate power of a normal distributed test statistic
...
def ftest_anova_power(effect_size, nobs, alpha, k_groups=..., df=...): # -> ndarray[Any, dtype[Any]]:
...
def ftest_power(effect_size, df_num, df_denom, alpha, ncc=...): # -> ndarray[Any, dtype[Any]]:
...
class NormalIndPower(Power):
    ...
    def power(self, effect_size, nobs1, alpha, ratio=..., alternative=...): # -> NDArray[Any] | NDArray[signedinteger[Any]] | Literal[0]:
...
class FTestPower(Power):
    ...
    '''
    def power(self, effect_size, df_num, df_denom, alpha, ncc=...): # -> ndarray[Any, dtype[Any]]:
        '''Calculate the power of a F-test.
...
class FTestAnovaPower(Power):
    ...
    '''
    def power(self, effect_size, nobs, alpha, k_groups=...): # -> ndarray[Any, dtype[Any]]:
...
class GofChisquarePower(Power):
    ...
    '''
    def power(self, effect_size, nobs, alpha, n_bins, ddof=...): # -> ndarray[Any, dtype[Any]]:
...
class _GofChisquareIndPower(Power):
    ...
    '''
    def power(self, effect_size, nobs1, alpha, ratio=..., alternative=...): # -> ndarray[Any, dtype[Any]]:
