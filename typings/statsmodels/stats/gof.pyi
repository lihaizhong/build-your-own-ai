...
'''
def powerdiscrepancy(observed, expected, lambd=..., axis=..., ddof=...): # -> tuple[Any, ndarray[Any, dtype[Any]]]:
...
def gof_binning_discrete(rvs, distfn, arg, nsupp=...): # -> tuple[NDArray[Any], NDArray[signedinteger[Any]], NDArray[floating[Any]]]:
...
def chisquare(f_obs, f_exp=..., value=..., ddof=..., return_basic=...): # -> tuple[Any, ndarray[Any, dtype[Any]]]:
...
def chisquare_power(effect_size, nobs, n_bins, alpha=..., ddof=...): # -> ndarray[Any, dtype[Any]]:
