...
class Table:
    ...
    @classmethod
    def from_data(cls, data, shift_zeros=...): # -> Self:
        """
    ...
    @cache_readonly
    def independence_probabilities(self): # -> DataFrame | NDArray[Any]:
        """
    ...
    @cache_readonly
    def local_log_oddsratios(self): # -> DataFrame | NDArray[floating[_64Bit]]:
        """
    ...
    @cache_readonly
    def cumulative_log_oddsratios(self): # -> DataFrame | NDArray[floating[_64Bit]]:
        """
...
class SquareTable(Table):
    ...
    def summary(self, alpha=..., float_format=...): # -> SimpleTable:
        """
...
class Table2x2(SquareTable):
    ...
    def oddsratio_pvalue(self, null=...): # -> NDArray[signedinteger[Any]]:
        """
    ...
    def log_oddsratio_pvalue(self, null=...): # -> NDArray[signedinteger[Any]]:
        """
    ...
    def log_oddsratio_confint(self, alpha=..., method=...): # -> tuple[Any, Any]:
        """
    ...
    def riskratio_pvalue(self, null=...): # -> NDArray[signedinteger[Any]]:
        """
    ...
    def log_riskratio_pvalue(self, null=...): # -> NDArray[signedinteger[Any]]:
        """
    ...
    def log_riskratio_confint(self, alpha=..., method=...): # -> tuple[Any, Any]:
        """
    ...
    def summary(self, alpha=..., float_format=..., method=...): # -> SimpleTable:
        """
...
class StratifiedTable:
    ...
    @classmethod
    def from_data(cls, var1, var2, strata, data): # -> Self:
        """
    ...
    def logodds_pooled_confint(self, alpha=..., method=...): # -> tuple[Any, Any]:
        """
...
def cochrans_q(x, return_object=...): # -> _Bunch | tuple[Any, ndarray[Any, dtype[Any]], Any]:
    """
