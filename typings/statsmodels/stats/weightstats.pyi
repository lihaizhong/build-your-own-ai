...
class DescrStatsW:
    ...
    def quantile(self, probs, return_pandas=...): # -> Series[float] | ndarray[Any, dtype[Any]] | DataFrame | NDArray[Any]:
        """
    ...
    def ttest_mean(self, value=..., alternative=...): # -> tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]] | Any, Any]:
    ...
    def ttost_mean(self, low, upp): # -> tuple[NDArray[Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any]]:
    ...
    def ztest_mean(self, value=..., alternative=...): # -> tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]] | Any]:
    ...
    def ztost_mean(self, low, upp): # -> tuple[NDArray[Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]]]:
...
class CompareMeans:
    ...
    def ttest_ind(self, alternative=..., usevar=..., value=...): # -> tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any]:
    ...
    def ztest_ind(self, alternative=..., usevar=..., value=...): # -> tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]]:
    ...
    def ttost_ind(self, low, upp, usevar=...): # -> tuple[NDArray[Any], tuple[tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any]]]:
        """
    ...
    def ztost_ind(self, low, upp, usevar=...): # -> tuple[NDArray[Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]]]:
        """
...
def ttest_ind(x1, x2, alternative=..., usevar=..., weights=..., value=...): # -> tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any]:
...
def ttost_ind(x1, x2, low, upp, usevar=..., weights=..., transform=...): # -> tuple[NDArray[Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any]]:
...
def ttost_paired(x1, x2, low, upp, transform=..., weights=...): # -> tuple[NDArray[Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]], Any]]:
...
def ztest(x1, x2=..., value=..., alternative=..., usevar=..., ddof=...): # -> tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]]:
...
def ztost(x1, low, upp, x2=..., usevar=..., ddof=...): # -> tuple[NDArray[Any], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]], tuple[Any, NDArray[signedinteger[Any]] | ndarray[Any, dtype[Any]]]]:
