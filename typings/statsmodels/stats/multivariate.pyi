...
License: BSD-3
"""
def test_mvmean(data, mean_null=..., return_results=...): # -> HolderTuple | tuple[Any, ndarray[Any, dtype[Any]]]:
...
def confint_mvmean(data, lin_transf=..., alpha=..., simult=...): # -> tuple[Any, Any, Any]:
...
def confint_mvmean_fromstats(mean, cov, nobs, lin_transf=..., alpha=..., simult=...): # -> tuple[Any, Any, Any]:
    """Confidence interval for linear transformation of a multivariate mean
