...
"""
def compute_all_knots(x, df, degree): # -> tuple[NDArray[Any], Any, Any, ndarray[Any, dtype[Any]]]:
    ...
...
def get_covder2(smoother, k_points=..., integration_points=..., skip_ctransf=..., deriv=...): # -> NDArray[floating[Any]] | float:
    """
...
class UnivariateBSplines(UnivariateGamSmoother):
    ...
    def transform(self, x_new, deriv=..., skip_ctransf=...): # -> tuple[NDArray[Any] | Any, NDArray[Any] | Any, NDArray[Any] | Any] | NDArray[Any]:
