...
class PCA:
    ...
    def project(self, ncomp=..., transform=..., unweight=...): # -> DataFrame | Any:
        """
...
def pca(data, ncomp=..., standardize=..., demean=..., normalize=..., gls=..., weights=..., method=...): # -> tuple[Any | DataFrame | None, Any | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[float64]] | Series[Any] | DataFrame | None, DataFrame | Any | None, Any | Series[Any] | None, Any | DataFrame | None, Any | NDArray[Any] | NDArray[float64] | Series[Any] | None, Any | NDArray[Any] | NDArray[float64] | Series[Any] | DataFrame | None]:
    """
