...
class Factor(Model):
    ...
    **Experimental**
    ...
    @property
    def endog_names(self): # -> NDArray[Any] | Any | list[str]:
...
class FactorResults:
    ...
    def factor_score_params(self, method=...): # -> Any:
        """
    ...
    def factor_scoring(self, endog=..., method=..., transform=...): # -> NDArray[Any]:
        """
    ...
    def get_loadings_frame(self, style=..., sort_=..., threshold=..., highlight_max=..., color_max=..., decimals=...): # -> DataFrame | Styler | None:
    ...
    def plot_loadings(self, loading_pairs=..., plot_prerotated=...): # -> list[Any]:
        """
