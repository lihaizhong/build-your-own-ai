...
"""
def GPA(A, ff=..., vgQ=..., T=..., max_tries=..., rotation_method=..., tol=...): # -> tuple[Any, Any, NDArray[float64] | Any, list[Any]]:
    r"""
...
def oblimin_objective(L=..., A=..., T=..., gamma=..., rotation_method=..., return_gradient=...): # -> tuple[Any, Any]:
    r"""
...
def orthomax_objective(L=..., A=..., T=..., gamma=..., return_gradient=...): # -> tuple[Any, Any]:
    r"""
...
def CF_objective(L=..., A=..., T=..., kappa=..., rotation_method=..., return_gradient=...): # -> tuple[Any, Any]:
    r"""
...
def vgQ_target(H, L=..., A=..., T=..., rotation_method=...): # -> tuple[floating[Any], Any]:
    r"""
...
def vgQ_partial_target(H, W=..., L=..., A=..., T=...): # -> tuple[floating[Any], Any]:
    r"""
