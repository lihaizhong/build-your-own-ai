...
class SimulationSmoothResults:
    ...
    @property
    def generated_measurement_disturbance(self): # -> ndarray[Any, dtype[Any]]:
        r"""
    ...
    @property
    def generated_state_disturbance(self): # -> ndarray[Any, dtype[Any]]:
        r"""
    ...
    @property
    def generated_obs(self): # -> NDArray[Any]:
        r"""
    ...
    @property
    def generated_state(self): # -> NDArray[Any]:
        r"""
    ...
    @property
    def simulated_state(self): # -> NDArray[Any]:
        r"""
    ...
    @property
    def simulated_measurement_disturbance(self): # -> NDArray[Any]:
        r"""
    ...
    @property
    def simulated_state_disturbance(self): # -> NDArray[Any]:
        r"""
