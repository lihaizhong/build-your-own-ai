...
class FactorBlock(dict):
    ...
    @property
    def factors_ix(self): # -> NDArray[Any]:
...
class DynamicFactorMQ(mlemodel.MLEModel):
    ...
    *Impulse responses*
    ...
    @property
    def start_params(self): # -> NDArray[floating[_64Bit]]:
    ...
    def simulate(self, params, nsimulations, measurement_shocks=..., state_shocks=..., initial_state=..., anchor=..., repetitions=..., exog=..., extend_model=..., extend_kwargs=..., transformed=..., includes_fixed=..., original_scale=..., **kwargs): # -> Series[float] | Any | NDArray[floating[Any]] | DataFrame | ndarray[Any, dtype[float64]] | Series[Any]:
        r"""
...
class DynamicFactorMQResults(mlemodel.MLEResults):
    ...
    def get_coefficients_of_determination(self, method=..., which=...): # -> DataFrame | Series[float]:
        """
    ...
    @cache_readonly
    def coefficients_of_determination(self): # -> DataFrame | Series[float]:
        """
