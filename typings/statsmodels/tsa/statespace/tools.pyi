...
def companion_matrix(polynomial): # -> NDArray[Any]:
    r"""
...
def concat(series, axis=..., allow_mix=...): # -> NDArray[Any]:
    """
...
def is_invertible(polynomial, threshold=...): # -> bool:
    r"""
...
def solve_discrete_lyapunov(a, q, complex_step=...): # -> Any:
    r"""
...
def constrain_stationary_univariate(unconstrained): # -> NDArray[float64]:
    """
...
def constrain_stationary_multivariate_python(unconstrained, error_variance, transform_variance=..., prefix=...): # -> tuple[ndarray[Any, dtype[Any]] | list[Any], Any]:
    r"""
    Transform unconstrained parameters used by the optimizer to constrained
...
def constrain_stationary_multivariate(unconstrained, variance, transform_variance=..., prefix=...): # -> tuple[list[ndarray[Any, dtype[complexfloating[_32Bit, _32Bit] | complexfloating[_64Bit, _64Bit] | floating[_32Bit] | floating[_64Bit]]]] | NDArray[complexfloating[_32Bit, _32Bit] | complexfloating[_64Bit, _64Bit] | floating[_32Bit] | floating[_64Bit]], NDArray[complexfloating[_32Bit, _32Bit] | complexfloating[_64Bit, _64Bit] | floating[_32Bit] | floating[_64Bit]]]:
    ...
...
def prepare_exog(exog): # -> tuple[Any | int, ndarray[Any, dtype[Any]] | Any | DataFrame]:
    ...
