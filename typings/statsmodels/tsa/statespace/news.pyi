...
class NewsResults:
    ...
    def summary_impacts(self, impact_date=..., impacted_variable=..., groupby=..., show_revisions_columns=..., sparsify=..., float_format=...): # -> SimpleTable:
        """
    ...
    def summary_details(self, impact_date=..., impacted_variable=..., update_date=..., updated_variable=..., groupby=..., sparsify=..., float_format=..., multiple_tables=...): # -> SimpleTable | list[Any]:
        """
        Create summary table with detailed impacts from news; by date, variable
