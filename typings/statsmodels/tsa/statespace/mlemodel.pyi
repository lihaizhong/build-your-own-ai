...
class MLEModel(tsbase.TimeSeriesModel):
    ...
    **kwargs
    ...
    def prepare_data(self): # -> tuple[NDArray[Any], NDArray[Any] | None]:
        """
    ...
    def fit(self, start_params=..., transformed=..., includes_fixed=..., cov_type=..., cov_kwds=..., method=..., maxiter=..., full_output=..., disp=..., callback=..., return_params=..., optim_score=..., optim_complex_step=..., optim_hessian=..., flags=..., low_memory=..., **kwargs): # -> tuple[NDArray[Any] | NDArray[floating[Any]] | NDArray[floating[_64Bit]], ndarray[Any, dtype[Any]] | Any] | NDArray[Any] | NDArray[floating[Any]] | NDArray[floating[_64Bit]] | MLEResultsWrapper:
        """
    ...
    def fit_constrained(self, constraints, start_params=..., **fit_kwds): # -> tuple[NDArray[Any] | NDArray[floating[Any]] | NDArray[floating[_64Bit]], ndarray[Any, dtype[Any]] | Any] | NDArray[Any] | NDArray[floating[Any]] | NDArray[floating[_64Bit]] | MLEResultsWrapper:
        """
    ...
    def observed_information_matrix(self, params, transformed=..., includes_fixed=..., approx_complex_step=..., approx_centered=..., **kwargs): # -> Any:
        """
    ...
    def score(self, params, *args, **kwargs): # -> Any | ndarray[Any, dtype[Any]]:
        """
    ...
    def score_obs(self, params, method=..., transformed=..., includes_fixed=..., approx_complex_step=..., approx_centered=..., **kwargs): # -> NDArray[floating[Any]] | NDArray[Any] | ndarray[Any, dtype[Any]]:
        """
    ...
    def hessian(self, params, *args, **kwargs): # -> Any:
        r"""
    ...
    def handle_params(self, params, transformed=..., includes_fixed=..., return_jacobian=...): # -> tuple[NDArray[Any] | NDArray[floating[Any]] | NDArray[floating[_64Bit]], ndarray[Any, dtype[Any]] | Any] | NDArray[Any] | NDArray[floating[Any]] | NDArray[floating[_64Bit]]:
        """
        Ensure model parameters satisfy shape and other requirements
        """
        ...
    
    def update(self, params, transformed=..., includes_fixed=..., complex_step=...): # -> tuple[NDArray[Any] | NDArray[floating[Any]] | NDArray[floating[_64Bit]], ndarray[Any, dtype[Any]] | Any] | NDArray[Any] | NDArray[floating[Any]] | NDArray[floating[_64Bit]]:
        """
    ...
    def simulate(self, params, nsimulations, measurement_shocks=..., state_shocks=..., initial_state=..., anchor=..., repetitions=..., exog=..., extend_model=..., extend_kwargs=..., transformed=..., includes_fixed=..., **kwargs): # -> Series[float] | ndarray[Any, dtype[float64]] | DataFrame:
        r"""
...
class MLEResults(tsbase.TimeSeriesModelResults):
    ...
    def test_serial_correlation(self, method, df_adjust=..., lags=...): # -> Any:
        """
    ...
    def predict(self, start=..., end=..., dynamic=..., **kwargs): # -> Any:
        """
        In-sample prediction and out-of-sample forecasting
    ...
    def forecast(self, steps=..., **kwargs): # -> Any:
        """
        Out-of-sample forecasts
    ...
    def impulse_responses(self, steps=..., impulse=..., orthogonalized=..., cumulative=..., **kwargs): # -> ArrayLike | np_2darray[Any]:
        """
        Impulse response function
...
class PredictionResults(pred.PredictionResults):
    ...
    def conf_int(self, method=..., alpha=..., **kwds): # -> DataFrame | Series[Any] | NDArray[Any]:
        ...
