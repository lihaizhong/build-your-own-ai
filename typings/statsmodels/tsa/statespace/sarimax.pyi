...
class SARIMAX(MLEModel):
    ...
    **kwargs
    ...
    def prepare_data(self): # -> tuple[NDArray[Any] | Any, NDArray[Any] | Any | None]:
        ...
    ...
    @property
    def initial_design(self): # -> Any | ndarray[Any, dtype[Any]]:
    ...
    @property
    def endog_names(self, latex=...): # -> str | Any:
    ...
    @property
    def model_orders(self): # -> dict[str, int | Any]:
        """
