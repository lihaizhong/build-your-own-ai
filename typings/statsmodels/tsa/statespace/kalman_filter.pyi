...
class KalmanFilter(Representation):
    ...
    **kwargs
    ...
    def impulse_responses(self, steps=..., impulse=..., orthogonalized=..., cumulative=..., direct=...): # -> ndarray[Any, dtype[Any]]:
        r"""
...
class FilterResults(FrozenRepresentation):
    ...
    @property
    def kalman_gain(self): # -> NDArray[float64] | NDArray[Any]:
        """
    ...
    @property
    def standardized_forecasts_error(self): # -> NDArray[floating[Any]] | NDArray[float64] | NDArray[Any] | None:
        r"""
