...
class Initialization:
    ...
    **Mixed**
    ...
    def set(self, index, initialization_type, constant=..., stationary_cov=..., approximate_diffuse_variance=...): # -> None:
        r"""
    ...
    def __call__(self, index=..., model=..., initial_state_mean=..., initial_diffuse_state_cov=..., initial_stationary_state_cov=..., complex_step=...): # -> tuple[NDArray[float64] | Any, NDArray[float64] | Any, NDArray[float64] | Any]:
        r"""
