...
SQRTEPS = ...
def adfuller(x, maxlag: int | None = ..., regression=..., autolag=..., store=..., regresults=...): # -> tuple[Any, float | ndarray[Any, dtype[Any]], dict[str, Any], ResultsStore | Any] | tuple[Any, float | ndarray[Any, dtype[Any]], Any | int | None, Any | int, dict[str, Any]] | tuple[Any, float | ndarray[Any, dtype[Any]], Any | int | None, Any | int, dict[str, Any], Any | float | None]:
    """
...
def acovf(x, adjusted=..., demean=..., fft=..., missing=..., nlag=...): # -> NDArray[floating[_64Bit]] | ndarray[Any, _dtype[floating[Any]]]:
    """
...
def q_stat(x, nobs): # -> tuple[NDArray[floating[Any]] | Any, ndarray[Any, dtype[Any]]]:
    """
...
def acf(x, adjusted=..., nlags=..., qstat=..., fft=..., alpha=..., bartlett_confint=..., missing=...): # -> Any | tuple[Any, NDArray[Any]] | tuple[Any, NDArray[Any] | Any, NDArray[floating[Any]] | Any, ndarray[Any, dtype[Any]]] | tuple[Any, NDArray[floating[Any]] | Any, ndarray[Any, dtype[Any]]] | None:
    """
...
def pacf_burg(x, nlags=..., demean=...): # -> tuple[NDArray[float64], Any]:
    """
...
@deprecate_kwarg("unbiased", "adjusted")
def pacf_ols(x, nlags=..., efficient=..., adjusted=...): # -> Any | NDArray[float64]:
    """
...
def pacf(x, nlags=..., method=..., alpha=...): # -> tuple[Any | NDArray[float64] | NDArray[Any], NDArray[Any]] | Any | NDArray[float64] | NDArray[Any]:
    """
...
@deprecate_kwarg("unbiased", "adjusted")
def ccovf(x, y, adjusted=..., demean=..., fft=...): # -> NDArray[float64] | NDArray[floating[Any]]:
    """
...
def levinson_durbin(s, nlags=..., isacov=...): # -> tuple[Any, ndarray[Any, dtype[Any]], NDArray[Any], NDArray[float64], NDArray[Any]]:
    """
...
def levinson_durbin_pacf(pacf, nlags=...): # -> tuple[ndarray[Any, dtype[Any]], NDArray[float64]]:
    """
...
def breakvar_heteroskedasticity_test(resid, subset_length=..., alternative=..., use_f=...): # -> tuple[Any, Any] | tuple[Any, ndarray[Any, dtype[Any]] | NDArray[signedinteger[Any]]]:
    r"""
...
def coint(y0, y1, trend=..., method=..., maxlag=..., autolag: str | None = ..., return_results=...): # -> tuple[Any | float, float | ndarray[Any, dtype[Any]], list[float] | ndarray[Any, dtype[Any]] | NDArray[floating[Any]]]:
    """
...
class ZivotAndrewsUnitRoot:
    ...
    def run(self, x, trim=..., maxlag=..., regression=..., autolag=...): # -> tuple[Any, Any, dict[str, Any], dict[str, Any] | Any | int | None, signedinteger[_NBitIntP]]:
        """
    ...
    def __call__(self, x, trim=..., maxlag=..., regression=..., autolag=...): # -> tuple[Any, Any, dict[str, Any], dict[str, Any] | Any | int | None, signedinteger[_NBitIntP]]:
        ...
