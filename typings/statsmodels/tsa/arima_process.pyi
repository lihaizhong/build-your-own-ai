...
NONSTATIONARY_ERROR = ...
def arma_generate_sample(ar, ma, nsample, scale=..., distrvs=..., axis=..., burnin=...): # -> ndarray[Any, dtype[Any]]:
    """
...
def arma_acovf(ar, ma, nobs=..., sigma2=..., dtype=...): # -> NDArray[floating[_64Bit]]:
    """
...
def arma_periodogram(ar, ma, worN=..., whole=...): # -> tuple[NDArray[floating[Any]], Any]:
    """
...
def arma_impulse_response(ar, ma, leads=...): # -> ndarray[Any, dtype[Any]] | tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
    """
...
def arma2ma(ar, ma, lags=...): # -> ndarray[Any, dtype[Any]] | tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
    """
...
def arma2ar(ar, ma, lags=...): # -> ndarray[Any, dtype[Any]] | tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
    """
...
def ar2arma(ar_des, p, q, n=..., mse=..., start=...): # -> tuple[tuple[Any], Any, Any | tuple[Any, Any]]:
    """
...
_arma_docs = ...
def lpol2index(ar): # -> tuple[Any | ndarray[Any, dtype[floating[_NBitDouble]]], NDArray[intp]]:
    """
...
def deconvolve(num, den, n=...): # -> tuple[ndarray[Any, dtype[Any]] | tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]] | Any | list[Any], Any | NDArray[floating[Any]]]:
...
class ArmaProcess:
    ...
    @classmethod
    def from_roots(cls, maroots=..., arroots=..., nobs=...): # -> Self:
        """
    ...
    @classmethod
    def from_coeffs(cls, arcoefs=..., macoefs=..., nobs=...): # -> Self:
        """
    ...
    @classmethod
    def from_estimation(cls, model_results, nobs=...): # -> Self:
        """
    ...
    def acovf(self, nobs=...): # -> NDArray[floating[_64Bit]]:
        ...
    ...
    def periodogram(self, nobs=...): # -> tuple[NDArray[floating[Any]], Any]:
        ...
    
    @Appender(remove_parameters(arma_impulse_response.__doc__, ["ar", "ma"]))
    def impulse_response(self, leads=...): # -> ndarray[Any, dtype[Any]] | tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
        ...
    
    @Appender(remove_parameters(arma2ma.__doc__, ["ar", "ma"]))
    def arma2ma(self, lags=...): # -> ndarray[Any, dtype[Any]] | tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
        ...
    
    @Appender(remove_parameters(arma2ar.__doc__, ["ar", "ma"]))
    def arma2ar(self, lags=...): # -> ndarray[Any, dtype[Any]] | tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
        ...
    
    @property
    def arroots(self): # -> _CoefSeries:
        """Roots of autoregressive lag-polynomial"""
        ...
    
    @property
    def maroots(self): # -> _CoefSeries:
    ...
    def invertroots(self, retnew=...): # -> Self | tuple[Any | NDArray[floating[_NBitDouble]] | None, bool]:
        """
    ...
    def generate_sample(self, nsample=..., scale=..., distrvs=..., axis=..., burnin=...): # -> ndarray[Any, dtype[Any]]:
        ...
