...
def seasonal_decompose(x, model=..., filt=..., period=..., two_sided=..., extrapolate_trend=...): # -> DecomposeResult:
    """
...
class DecomposeResult:
    ...
    @property
    def observed(self): # -> Series[Any] | Any:
        """Observed data"""
        ...
    ...
    @property
    def weights(self): # -> Series[float] | Any:
        """The weights used in the robust estimation"""
        ...
    
    @property
    def nobs(self): # -> tuple[int, ...]:
        """Number of observations"""
        ...
    
    def plot(self, observed=..., seasonal=..., trend=..., resid=..., weights=...): # -> Figure:
        """
