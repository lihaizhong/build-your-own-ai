...
class SARIMAXParams:
    ...
    @property
    def reduced_ar_poly(self): # -> Polynomial:
        """(Polynomial) Reduced form autoregressive lag polynomial."""
        ...
    
    @property
    def reduced_ma_poly(self): # -> Polynomial:
    ...
    @property
    def is_stationary(self): # -> bool | Literal[True]:
        """(bool) Is the reduced autoregressive lag poylnomial stationary."""
        ...
    
    @property
    def is_invertible(self): # -> bool | Literal[True]:
