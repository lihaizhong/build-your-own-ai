...
License: BSD-3
"""
def statespace(endog, exog=..., order=..., seasonal_order=..., include_constant=..., enforce_stationarity=..., enforce_invertibility=..., concentrate_scale=..., start_params=..., fit_kwargs=...): # -> tuple[SARIMAXParams, Bunch]:
    """
