...
def x13_arima_analysis(endog, maxorder=..., maxdiff=..., diff=..., exog=..., log=..., outlier=..., trading=..., forecast_periods=..., retspec=..., speconly=..., start=..., freq=..., print_stdout=..., x12path=..., prefer_x13=...): # -> str | X13ArimaAnalysisResult:
    """
