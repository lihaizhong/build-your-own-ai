...
class ARDL(AutoReg):
    ...
    @classmethod
    def from_formula(cls, formula: str, data: pd.DataFrame, lags: Union[None, int, Sequence[int]] = ..., order: _ARDLOrder = ..., trend: Literal[n, c, ct, ctt] = ..., *, causal: bool = ..., seasonal: bool = ..., deterministic: Optional[DeterministicProcess] = ..., hold_back: Optional[int] = ..., period: Optional[int] = ..., missing: Literal[none, "raise"] = ...) -> ARDL:
        """
...
class UECM(ARDL):
    ...
    @classmethod
    def from_ardl(cls, ardl: ARDL, missing: Literal[none, drop, "raise"] = ...): # -> Self:
        """
    ...
    def from_formula(cls, formula: str, data: pd.DataFrame, lags: Union[None, int, Sequence[int]] = ..., order: _ARDLOrder = ..., trend: Literal[n, c, ct, ctt] = ..., *, causal: bool = ..., seasonal: bool = ..., deterministic: Optional[DeterministicProcess] = ..., hold_back: Optional[int] = ..., period: Optional[int] = ..., missing: Literal[none, "raise"] = ...) -> UECM:
        ...
