...
class MarkovSwitching(tsbase.TimeSeriesModel):
    ...
    def regime_transition_matrix(self, params, exog_tvtp=...): # -> NDArray[Any]:
        """
    ...
    def loglike(self, params, transformed=...): # -> float64:
        """
    ...
    def score(self, params, transformed=...): # -> NDArray[Any]:
        """
    ...
    def score_obs(self, params, transformed=...): # -> NDArray[Any]:
        """
    ...
    def fit(self, start_params=..., transformed=..., cov_type=..., cov_kwds=..., method=..., maxiter=..., full_output=..., disp=..., callback=..., return_params=..., em_iter=..., search_reps=..., search_iter=..., search_scale=..., **kwargs): # -> NDArray[Any] | MarkovSwitchingResultsWrapper:
        """
...
class HamiltonFilterResults:
    ...
    @property
    def expected_durations(self): # -> ndarray[Any, dtype[Any]]:
        """
