...
def select_order(data, maxlags, deterministic=..., seasons=..., exog=..., exog_coint=...): # -> LagOrderResults:
    """
...
class JohansenTestResult:
    ...
    @property
    def trace_stat_crit_vals(self): # -> Any:
    ...
    @property
    def max_eig_stat_crit_vals(self): # -> Any:
        """Critical values (90%, 95%, 99%) of maximum eigenvalue statistic."""
        ...
...
class VECMResults:
    ...
    @cache_readonly
    def stderr_det_coef_coint(self): # -> NDArray[complexfloating[Any, Any] | floating[Any]] | ndarray[Any, dtype[float64]]:
        ...
    ...
    @cache_readonly
    def stderr_det_coef(self): # -> NDArray[complexfloating[Any, Any] | floating[Any]] | ndarray[Any, dtype[Any]]:
        ...
    ...
    @cache_readonly
    def tvalues_beta(self): # -> NDArray[complexfloating[Any, Any] | float64]:
        ...
    
    @cache_readonly
    def tvalues_det_coef_coint(self): # -> NDArray[complexfloating[Any, Any] | floating[Any]] | NDArray[number[Any]] | NDArray[complexfloating[Any, Any]]:
        ...
    ...
    @cache_readonly
    def tvalues_det_coef(self): # -> NDArray[complexfloating[Any, Any] | floating[Any]] | NDArray[number[Any]] | NDArray[complexfloating[Any, Any]]:
        ...
    
    @cache_readonly
    def pvalues_alpha(self): # -> NDArray[signedinteger[Any]]:
        ...
    
    @cache_readonly
    def pvalues_beta(self): # -> NDArray[float64 | signedinteger[Any]]:
        ...
    
    @cache_readonly
    def pvalues_det_coef_coint(self): # -> NDArray[complexfloating[Any, Any] | floating[Any]] | NDArray[signedinteger[Any]]:
        ...
    
    @cache_readonly
    def pvalues_gamma(self): # -> NDArray[signedinteger[Any]]:
        ...
    
    @cache_readonly
    def pvalues_det_coef(self): # -> NDArray[complexfloating[Any, Any] | floating[Any]] | NDArray[signedinteger[Any]]:
        ...
    ...
    def orth_ma_rep(self, maxn=..., P=...): # -> NDArray[Any]:
    ...
    def predict(self, steps=..., alpha=..., exog_fc=..., exog_coint_fc=...): # -> tuple[Any | NDArray[float64], Any | NDArray[floating[Any]], Any | NDArray[floating[Any]]] | Any | NDArray[float64]:
        """
    ...
    def test_granger_causality(self, caused, causing=..., signif=...): # -> CausalityTestResults:
        r"""
    ...
    def test_inst_causality(self, causing, signif=...): # -> Any:
        r"""
