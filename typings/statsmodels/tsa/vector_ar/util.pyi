...
"""
def get_var_endog(y, lags, trend=..., has_constant=...): # -> DataFrame | NDArray[floating[Any]] | NDArray[Any]:
    """
...
def make_lag_names(names, lag_order, trendorder=..., exog=...): # -> list[Any]:
    """
...
def parse_lutkepohl_data(path): # -> tuple[recarray[Any, Any], DatetimeIndex]:
    """
...
def norm_signif_level(alpha=...): # -> ndarray[Any, dtype[Any]]:
    ...
...
def eigval_decomp(sym_array): # -> tuple[Any | NDArray[Any], Any | NDArray[Any], intp]:
    """
    Returns
    -------
