...
mse = ...
def forecast(y, coefs, trend_coefs, steps, exog=...): # -> Any | NDArray[float64]:
    """
...
def forecast_interval(y, coefs, trend_coefs, sig_u, steps=..., alpha=..., exog=...): # -> tuple[Any | NDArray[float64], Any | NDArray[floating[Any]], Any | NDArray[floating[Any]]]:
    ...
...
def orth_ma_rep(results, maxn=..., P=...): # -> NDArray[Any]:
...
class VAR(TimeSeriesModel):
    ...
    def predict(self, params, start=..., end=..., lags=..., trend=...): # -> NDArray[Any] | NDArray[floating[_64Bit]]:
        """
...
class VARProcess:
    ...
    def simulate_var(self, steps=..., offset=..., seed=...): # -> NDArray[floating[_64Bit]]:
        """
    ...
    def forecast(self, y, steps, exog_future=...): # -> Any | NDArray[float64]:
    ...
    forecast_cov = ...
    def forecast_interval(self, y, steps, alpha=..., exog_future=...): # -> tuple[Any | NDArray[float64], Any | NDArray[floating[Any]], Any | NDArray[floating[Any]]]:
        """
    ...
    def to_vecm(self): # -> dict[str, NDArray[float64] | Any]:
        """to_vecm"""
        ...
...
class VARResults(VARProcess):
    ...
    @cache_readonly
    def pvalues(self): # -> NDArray[signedinteger[Any]]:
        """
    ...
    @cache_readonly
    def pvalues_endog_lagged(self): # -> ndarray[Any, dtype[signedinteger[Any]]]:
        """pvalues_endog_laggd"""
        ...
    
    @cache_readonly
    def pvalues_dt(self): # -> ndarray[Any, dtype[signedinteger[Any]]]:
        """pvalues_dt"""
        ...
    ...
    def irf_errband_mc(self, orth=..., repl=..., steps=..., signif=..., seed=..., burn=..., cum=...): # -> tuple[ndarray[Any, dtype[float64]], ndarray[Any, dtype[float64]]]:
        """
    ...
    def test_causality(self, caused, causing=..., kind=..., signif=...): # -> CausalityTestResults:
        """
    ...
    @cache_readonly
    def info_criteria(self): # -> dict[str, Any | float]:
    ...
    @cache_readonly
    def roots(self): # -> ndarray[Any, dtype[signedinteger[Any]]]:
        """
