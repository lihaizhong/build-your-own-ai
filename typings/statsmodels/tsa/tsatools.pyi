...
def add_trend(x, trend=..., prepend=..., has_constant=...): # -> DataFrame | NDArray[floating[Any]]:
    """
...
def add_lag(x, col=..., lags=..., drop=..., insert=...): # -> NDArray[float64]:
    """
...
def lagmat(x, maxlag: int, trim: Literal[forward, backward, both, none] = ..., original: Literal[ex, sep, "in"] = ..., use_pandas: bool = ...): # -> tuple[DataFrame | ndarray[Any, dtype[float64]], DataFrame | Any | ndarray[Any, dtype[float64]]] | DataFrame | ndarray[Any, dtype[float64]]:
    """
...
def duplication_matrix(n): # -> NDArray[floating[Any]]:
    """
...
def elimination_matrix(n): # -> ndarray[Any, dtype[float64]]:
    """
...
def unintegrate(x, levels): # -> NDArray[Any]:
    """
