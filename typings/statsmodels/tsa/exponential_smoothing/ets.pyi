...
class ETSModel(base.StateSpaceMLEModel):
    ...
    @staticmethod
    def prepare_data(data): # -> tuple[NDArray[Any], None]:
        """
    ...
    def fit(self, start_params=..., maxiter=..., full_output=..., disp=..., callback=..., return_params=..., **kwargs): # -> NDArray[Any] | NDArray[float64] | tuple[Series[float] | NDArray[float64], DataFrame | NDArray[float64]]:
        r"""
    ...
    def smooth(self, params, return_raw=...): # -> tuple[Series[float] | NDArray[float64], DataFrame | NDArray[float64]]:
        """
    ...
    def score(self, params, approx_centered=..., approx_complex_step=..., **kwargs): # -> NDArray[Any] | ndarray[Any, dtype[Any]]:
        ...
...
class PredictionResults:
    ...
    **simulate_kwargs :
    ...
    @property
    def var_pred_mean(self): # -> Any | Series[Any]:
