...
class PredictionResults:
    ...
    @property
    def predicted_mean(self): # -> Series[Any] | DataFrame:
        """The predicted mean"""
        ...
    
    @property
    def var_pred_mean(self): # -> NDArray[Any] | Series[Any] | DataFrame:
        """The variance of the predicted mean"""
        ...
    
    @property
    def se_mean(self): # -> Series[Any] | DataFrame:
        """The standard deviation of the predicted mean"""
        ...
    
    @property
    def tvalues(self): # -> Series[Any] | DataFrame:
        """The ratio of the predicted mean to its standard deviation"""
        ...
    
    def t_test(self, value=..., alternative=...): # -> tuple[Any | Series[Any] | DataFrame, NDArray[signedinteger[Any]] | Any | ndarray[Any, dtype[Any]]]:
        """
    ...
    def conf_int(self, alpha=...): # -> Series[Any] | DataFrame | NDArray[Any]:
        """
