...
def get_prediction_index(start, end, nobs, base_index, index=..., silent=..., index_none=..., index_generated=..., data=...): # -> tuple[object | Any | Integral, Any | _ComplexLike, int, Index[Any] | Any | None]:
    """
    Get the location of a specific key in an index or model row labels
