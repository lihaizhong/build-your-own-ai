...
SMOOTHERS = ...
PY_SMOOTHERS = ...
def opt_wrapper(func): # -> Callable[..., NDArray[Any] | Any]:
    ...
...
class ExponentialSmoothing(TimeSeriesModel):
    ...
    def fix_params(self, values): # -> Generator[None, Any, None]:
        """
    ...
    def fit(self, smoothing_level=..., smoothing_trend=..., smoothing_seasonal=..., damping_trend=..., *, optimized=..., remove_bias=..., start_params=..., method=..., minimize_kwargs=..., use_brute=..., use_boxcox=..., use_basinhopping=..., initial_level=..., initial_trend=...): # -> HoltWintersResultsWrapper:
        """
        Fit the model
    ...
    def initial_values(self, initial_level=..., initial_trend=..., force=...): # -> tuple[float | Any | NDArray[Any] | NDArray[floating[_NBitDouble]] | tuple[Any, ndarray[Any, Any] | ndarray[tuple[int, ...], dtype[Any]] | Any] | tuple[Any, ndarray[Any, Any] | ndarray[tuple[int, ...], dtype[Any]] | Any, tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any]] | None, float | Any | None, NDArray[floating[_NBitDouble]] | Any | None] | tuple[Any | NDArray[Any] | NDArray[floating[_NBitDouble]] | tuple[Any, ndarray[Any, Any] | ndarray[tuple[int, ...], dtype[Any]] | Any] | tuple[Any, ndarray[Any, Any] | ndarray[tuple[int, ...], dtype[Any]] | Any, tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any]], Any | NDArray[Any] | NDArray[floating[Any]] | None, list[Any]]:
        """
...
class SimpleExpSmoothing(ExponentialSmoothing):
    ...
    def fit(self, smoothing_level=..., *, optimized=..., start_params=..., initial_level=..., use_brute=..., use_boxcox=..., remove_bias=..., method=..., minimize_kwargs=...): # -> HoltWintersResultsWrapper:
        """
        Fit the model
...
class Holt(ExponentialSmoothing):
    ...
    @deprecate_kwarg("initial_slope", "initial_trend")
    @deprecate_kwarg("damping_slope", "damping_trend")
    def fit(self, smoothing_level=..., smoothing_trend=..., *, damping_trend=..., optimized=..., start_params=..., initial_level=..., initial_trend=..., use_brute=..., use_boxcox=..., remove_bias=..., method=..., minimize_kwargs=...): # -> HoltWintersResultsWrapper:
        """
        Fit the model
