...
def arma_innovations(endog, ar_params=..., ma_params=..., sigma2=..., normalize=..., prefix=...): # -> tuple[ndarray[Any, dtype[floating[Any]]] | ndarray[Any, dtype[Any]], NDArray[Any]]:
    """
...
def arma_score(endog, ar_params=..., ma_params=..., sigma2=..., prefix=...): # -> NDArray[Any]:
    """
...
def arma_scoreobs(endog, ar_params=..., ma_params=..., sigma2=..., prefix=...): # -> NDArray[Any]:
    """
