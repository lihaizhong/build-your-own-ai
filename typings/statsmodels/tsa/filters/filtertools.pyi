...
def recursive_filter(x, ar_coeff, init=...): # -> NDArray[Any] | Series[float] | DataFrame:
    """
...
def convolution_filter(x, filt, nsides=...): # -> NDArray[Any] | Series[float] | DataFrame:
    """
...
def miso_lfilter(ar, ma, x, useic=...): # -> tuple[Any | ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]] | Any] | tuple[ndarray[Any, dtype[Any]] | tuple[ndarray[Any, dtype[Any]], ...] | Any, ndarray[Any, dtype[Any]] | Any]:
    """
