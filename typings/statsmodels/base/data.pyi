...
class PandasData(ModelData):
    ...
    results
    """
    def attach_generic_columns(self, result, names): # -> Series[Any]:
        ...
    
    def attach_generic_columns_2d(self, result, rownames, colnames=...): # -> DataFrame:
        ...
    
    def attach_columns(self, result): # -> Series[Any] | DataFrame:
        ...
    ...
    def attach_rows(self, result): # -> Series[Any] | DataFrame:
        ...
    
    def attach_dates(self, result): # -> Series[float] | DataFrame:
        ...
    
    def attach_mv_confint(self, result): # -> DataFrame:
        ...
    
    def attach_ynames(self, result): # -> Series[Any] | DataFrame:
        ...
