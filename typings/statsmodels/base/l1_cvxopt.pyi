...
"""
def fit_l1_cvxopt_cp(f, score, start_params, args, kwargs, disp=..., maxiter=..., callback=..., retall=..., full_output=..., hess=...): # -> tuple[Any | ndarray[Any, dtype[Any]], dict[str, Any | float | NDArray[Any]] | Any] | ndarray[Any, dtype[Any]]:
    """
