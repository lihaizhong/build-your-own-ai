...
class GEE(GLM):
    ...
    def compare_score_test(self, submodel): # -> dict[str, Any | int | NDArray[signedinteger[Any]]] | None:
        """
...
class OrdinalGEE(GEE):
    ...
    def setup_ordinal(self, endog, exog, groups, time, offset): # -> tuple[Series[float] | NDArray[floating[_64Bit]], DataFrame, NDArray[Any], NDArray[floating[_64Bit]], NDArray[floating[_64Bit]]]:
        """
...
class NominalGEE(GEE):
    ...
    def setup_nominal(self, endog, exog, groups, time, offset): # -> tuple[Series[float] | NDArray[floating[_64Bit]], DataFrame, NDArray[floating[_64Bit]], NDArray[floating[_64Bit]], NDArray[floating[_64Bit]]]:
        """
