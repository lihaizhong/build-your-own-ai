...
class GLM(base.LikelihoodModel):
    ...
    def score_test(self, params_constrained, k_constraints=..., exog_extra=..., observed=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any]:
...
class GLMResults(base.LikelihoodModelResults):
    ...
    def get_prediction(self, exog=..., exposure=..., offset=..., transform=..., linear=..., row_labels=...): # -> PredictionResults:
        ...
