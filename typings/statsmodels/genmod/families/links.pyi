...
class CDFLink(Logit):
    ...
    def __call__(self, p): # -> ndarray[Any, dtype[Any]]:
        """
        CDF link function
    ...
    def inverse(self, z): # -> ndarray[Any, dtype[Any]]:
        """
    ...
    def deriv(self, p): # -> NDArray[floating[Any]]:
        """
    ...
    def deriv2(self, p): # -> Any | NDArray[floating[Any]] | NDArray[float64]:
        """
        Second derivative of the link function g''(p)
    ...
    def deriv2_numdiff(self, p): # -> Any | NDArray[floating[Any]]:
        """
        Second derivative of the link function g''(p)
    ...
    def inverse_deriv(self, z): # -> ndarray[Any, dtype[Any]]:
        """
    ...
    def inverse_deriv2(self, z): # -> Any | NDArray[floating[Any]] | NDArray[Any]:
        """
        Second derivative of the inverse link function g^(-1)(z).
...
class probit(CDFLink):
    ...
    def deriv2(self, p): # -> NDArray[float64]:
        """
        Second derivative of the link function g''(p)
