...
class CovStruct:
    ...
    def covariance_matrix_solve(self, expval, index, stdev, rhs): # -> list[Any]:
        """
...
class Independence(CovStruct):
    ...
    def covariance_matrix(self, expval, index): # -> tuple[NDArray[floating[_64Bit]], Literal[True]]:
        ...
...
class Unstructured(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, endog_expval, index): # -> tuple[ndarray[Any, dtype[float64]] | Any, Literal[True]]:
        ...
...
class Exchangeable(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, expval, index): # -> tuple[NDArray[floating[Any]] | Any, Literal[True]]:
        ...
...
class Nested(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, expval, index): # -> tuple[NDArray[floating[_64Bit]], Literal[True]] | tuple[Any, Literal[True]]:
        ...
...
class Stationary(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, endog_expval, index): # -> tuple[NDArray[Any], Literal[True]] | tuple[NDArray[float64], Literal[True]]:
        ...
    
    def covariance_matrix_grid(self, endog_expval, index): # -> tuple[NDArray[Any], Literal[True]]:
        ...
...
class Autoregressive(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, endog_expval, index): # -> tuple[NDArray[floating[_64Bit]], Literal[True]] | tuple[NDArray[floating[Any]] | Any | NDArray[signedinteger[Any]] | NDArray[Any], Literal[True]]:
        ...
    ...
    def summary(self): # -> str | LiteralString:
        ...
...
class GlobalOddsRatio(CategoricalCovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, expected_value, index): # -> tuple[NDArray[Any] | Any, Literal[False]]:
        ...
    ...
    def get_eyy(self, endog_expval, index): # -> NDArray[Any]:
        """
