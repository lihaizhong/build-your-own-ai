...
class PredictionResults:
    ...
    def t_test(self, value=..., alternative=...): # -> tuple[Any, NDArray[signedinteger[Any]] | Any | ndarray[Any, dtype[Any]]]:
...
def get_prediction_glm(self, exog=..., transform=..., weights=..., row_labels=..., linpred=..., link=..., pred_kwds=...): # -> PredictionResults:
    """
