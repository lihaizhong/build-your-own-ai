...
class MultinomialModel(BinaryModel):
    ...
    def predict(self, params, exog=..., linear=...): # -> NDArray[float64] | Any:
        """
        Predict response variable of a model given exogenous variables.
...
class CountModel(DiscreteModel):
    ...
    def predict(self, params, exog=..., exposure=..., offset=..., linear=...): # -> Any:
        """
...
class Poisson(CountModel):
    ...
    def cdf(self, X): # -> ndarray[Any, dtype[Any]]:
        """
...
class GeneralizedPoisson(CountModel):
    ...
    def predict(self, params, exog=..., exposure=..., offset=..., which=...): # -> Any | ndarray[Any, dtype[Any]]:
        """
        Predict response variable of a count model given exogenous variables.
...
class Logit(BinaryModel):
    ...
    def score_obs(self, params): # -> NDArray[floating[Any]]:
        """
...
class MNLogit(MultinomialModel):
    ...
    def hessian(self, params): # -> ndarray[Any, dtype[Any]]:
        """
...
class NegativeBinomialP(CountModel):
    ...
    @Appender(DiscreteModel.fit.__doc__)
    def fit(self, start_params=..., method=..., maxiter=..., full_output=..., disp=..., callback=..., use_transparams=..., cov_type=..., cov_kwds=..., use_t=..., optim_kwds_prelim=..., **kwargs): # -> NegativeBinomialResultsWrapper:
        """
        use_transparams : bool
            This parameter enable internal transformation to impose
            non-negativity. True to enable. Default is False.
...
class DiscreteResults(base.LikelihoodModelResults):
    ...
    @cache_readonly
    def llr_pvalue(self): # -> ndarray[Any, dtype[Any]]:
        """
...
class PoissonResults(CountResults):
    def predict_prob(self, n=..., exog=..., exposure=..., offset=..., transform=...): # -> ndarray[Any, dtype[Any]]:
        """
