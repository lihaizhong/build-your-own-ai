...
class GenericZeroInflated(CountModel):
    ...
    def loglike(self, params): # -> floating[_64Bit]:
        """
    ...
    def loglikeobs(self, params): # -> NDArray[floating[_64Bit]]:
        """
    ...
    def score_obs(self, params): # -> ndarray[Any, dtype[Any]] | NDArray[floating[_64Bit]]:
        """
    ...
    def predict(self, params, exog=..., exog_infl=..., exposure=..., offset=..., which=...): # -> Any:
        """
