...
def gaussian_convolution(h, Xi, x): # -> Any:
    """ Calculates the Gaussian Convolution Kernel """
    ...

def wang_ryzin_convolution(h, Xi, Xj): # -> NDArray[float64]:
    ...

def aitchison_aitken_convolution(h, Xi, Xj): # -> NDArray[float64]:
    ...

def gaussian_cdf(h, Xi, x):
    ...

def aitchison_aitken_cdf(h, Xi, x_u): # -> NDArray[float64]:
    ...

def wang_ryzin_cdf(h, Xi, x_u): # -> NDArray[float64]:
    ...

def d_gaussian(h, Xi, x):
    ...

def aitchison_aitken_reg(h, Xi, x): # -> NDArray[float64]:
    """
