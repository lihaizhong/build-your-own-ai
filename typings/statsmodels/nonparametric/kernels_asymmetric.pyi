...
"""
doc_params = ...
def pdf_kernel_asym(x, sample, bw, kernel_type, weights=..., batch_size=...): # -> Any | NDArray[floating[Any]]:
...
def cdf_kernel_asym(x, sample, bw, kernel_type, weights=..., batch_size=...): # -> Any | NDArray[floating[Any]]:
...
def kernel_pdf_beta(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_cdf_beta(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_pdf_beta2(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_cdf_beta2(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_pdf_gamma(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_cdf_gamma(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_pdf_gamma2(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_cdf_gamma2(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_pdf_invgamma(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_cdf_invgamma(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_pdf_invgauss(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...
...
def kernel_cdf_invgauss(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_pdf_recipinvgauss(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...
...
def kernel_cdf_recipinvgauss(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_pdf_bs(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_cdf_bs(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_pdf_lognorm(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_cdf_lognorm(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...
...
def kernel_pdf_weibull(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...

def kernel_cdf_weibull(x, sample, bw): # -> ndarray[Any, dtype[Any]]:
    ...
