...
class KDEUnivariate:
    ...
    def fit(self, kernel=..., bw=..., fft=..., weights=..., gridsize=..., adjust=..., cut=..., clip=...): # -> Self:
        """
    ...
    @cache_readonly
    def cumhazard(self): # -> NDArray[Any]:
        """
...
def kdensity(x, kernel=..., bw=..., weights=..., gridsize=..., adjust=..., clip=..., cut=..., retgrid=...): # -> tuple[Any, Any, float | Any] | tuple[Any, float | Any]:
    """
...
def kdensityfft(x, kernel=..., bw=..., weights=..., gridsize=..., adjust=..., clip=..., cut=..., retgrid=...): # -> tuple[NDArray[floating[Any]], Any, float | Any] | tuple[NDArray[floating[Any]], float | Any]:
    """
    Rosenblatt-Parzen univariate kernel density estimator
