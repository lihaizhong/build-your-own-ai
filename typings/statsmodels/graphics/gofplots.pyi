...
class ProbPlot:
    ...
    @cache_readonly
    def theoretical_quantiles(self): # -> ndarray[Any, dtype[Any]]:
    ...
    @cache_readonly
    def sample_quantiles(self): # -> Any | NDArray[floating[Any]] | NDArray[Any]:
        """sample quantiles"""
        ...
    
    @cache_readonly
    def sample_percentiles(self): # -> ndarray[Any, dtype[Any]]:
        """Sample percentiles"""
        ...
