...
def plot_acf(x, ax=..., lags=..., *, alpha=..., use_vlines=..., adjusted=..., fft=..., missing=..., title=..., zero=..., auto_ylims=..., bartlett_confint=..., vlines_kwargs=..., **kwargs): # -> Figure:
    """
...
def plot_pacf(x, ax=..., lags=..., alpha=..., method=..., use_vlines=..., title=..., zero=..., vlines_kwargs=..., **kwargs): # -> Figure:
    """
...
def seasonal_plot(grouped_x, xticklabels, ylabel=..., ax=...): # -> Figure:
    """
...
def month_plot(x, dates=..., ylabel=..., ax=...): # -> Figure:
    """
...
def quarter_plot(x, dates=..., ylabel=..., ax=...): # -> Figure:
    """
...
def plot_predict(result, start=..., end=..., dynamic=..., alpha=..., ax=..., **predict_kwargs): # -> Figure:
    """
