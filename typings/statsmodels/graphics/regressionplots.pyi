...
def plot_regress_exog(results, exog_idx, fig=...): # -> Figure:
...
def plot_partregress(endog, exog_i, exog_others, data=..., title_kwargs=..., obs_labels=..., label_kwargs=..., ax=..., ret_coords=..., eval_env=..., **kwargs): # -> tuple[Figure | Any, tuple[Any, Any]] | Figure:
...
def plot_ccpr(results, exog_idx, ax=...): # -> Figure:
    """
...
def abline_plot(intercept=..., slope=..., horiz=..., vert=..., model_results=..., ax=..., **kwargs): # -> Figure:
    """
...
def ceres_resids(results, focus_exog, frac=..., cond_means=...): # -> Any:
    """
...
def added_variable_resids(results, focus_exog, resid_type=..., use_glm_weights=..., fit_kwargs=...): # -> tuple[Any, Any]:
    """
