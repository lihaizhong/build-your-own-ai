...
def pdf_moments_st(cnt): # -> tuple[Callable[..., Any], poly1d]:
...
def pdf_mvsk(mvsk): # -> Callable[..., Any]:
...
def pdf_moments(cnt): # -> Callable[..., Any]:
    """Return the Gaussian expanded pdf function given the list of central
    moments (first one is mean).
...
def get_u_argskwargs(**kwargs): # -> tuple[Any, dict[str, Any]]:
    ...
...
absnormalg = ...
informcode = ...
def mvstdnormcdf(lower, upper, corrcoef, **kwds): # -> Any:
