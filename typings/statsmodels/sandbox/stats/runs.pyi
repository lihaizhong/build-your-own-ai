...
class Runs:
    ...
    def runs_test(self, correction=...): # -> tuple[Any, NDArray[signedinteger[Any]]]:
...
def runstest_1samp(x, cutoff=..., correction=...): # -> tuple[Any, NDArray[signedinteger[Any]]]:
...
def runstest_2samp(x, y=..., groups=..., correction=...): # -> tuple[Any, NDArray[signedinteger[Any]]]:
...
class TotalRunsProb:
    ...
    *Status*
    ...
    def runs_prob_even(self, r): # -> NDArray[floating[Any]] | Any | floating[_64Bit | Any]:
        ...
    
    def runs_prob_odd(self, r): # -> NDArray[Any] | NDArray[floating[Any]] | Any | floating[_64Bit]:
        ...
...
def median_test_ksample(x, groups): # -> tuple[Power_divergenceResult, NDArray[Any], NDArray[Any]]:
...
def cochrans_q(x): # -> tuple[Any, ndarray[Any, dtype[Any]]]:
...
def mcnemar(x, y=..., exact=..., correction=...): # -> tuple[Any, NDArray[Any]]:
    '''McNemar test
...
def symmetry_bowker(table): # -> tuple[Any, ndarray[Any, dtype[Any]], Any]:
