...
def get_tukeyQcrit2(k, df, alpha=...): # -> ndarray[Any, dtype[Any]]:
    '''
    return critical values for Tukey's HSD (Q)
...
def get_tukey_pvalue(k, df, q): # -> ndarray[Any, dtype[Any]]:
    '''
...
def catstack(args): # -> tuple[NDArray[Any], NDArray[floating[Any]]]:
    ...
...
def fdrcorrection_bak(pvals, alpha=..., method=...): # -> ndarray[Any, dtype[bool]]:
...
def randmvn(rho, size=..., standardize=...): # -> NDArray[float64] | Any:
...
class GroupsStats:
    ...
    def groupdemean(self): # -> NDArray[floating[Any]]:
        """groupdemean"""
        ...
...
class MultiComparison:
    ...
    def kruskal(self, pairs=..., multimethod=...): # -> NDArray[signedinteger[Any]] | None:
        '''
    ...
    def allpairtest(self, testfunc, alpha=..., method=..., pvalidx=...): # -> tuple[SimpleTable, tuple[NDArray[Any], NDArray[bool] | Any, Any | NDArray[floating[Any]] | NDArray[Any], Any, float], NDArray[Any]]:
...
def rankdata(x): # -> ndarray[Any, dtype[floating[Any]]]:
...
def varcorrection_pairs_unequal(var_all, nobs_all, df_all): # -> tuple[NDArray[Any], NDArray[float64]]:
    '''return joint variance from samples with unequal variances and unequal
...
def tukeyhsd(mean_all, nobs_all, var_all, df=..., alpha=..., q_crit=...): # -> tuple[tuple[NDArray[int_], NDArray[int_]], NDArray[bool] | Any, ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]], NDArray[Any], ndarray[Any, dtype[Any]] | Any, Any, NDArray[bool] | Any, NDArray[Any]]:
...
def distance_st_range(mean_all, nobs_all, var_all, df=..., triu=...): # -> tuple[Any | NDArray[Any], Any | NDArray[Any], Any | NDArray[Any], tuple[NDArray[int_], NDArray[int_]]]:
