...
class LeaveOneOut:
    ...
    def __iter__(self): # -> Generator[tuple[NDArray[Any], NDArray[Any]], Any, None]:
        ...
...
class KStepAhead:
    ...
    def __iter__(self): # -> Generator[tuple[slice[Any, int, Any], slice[int, int, Any]] | tuple[NDArray[Any], NDArray[Any]], Any, None]:
        ...
