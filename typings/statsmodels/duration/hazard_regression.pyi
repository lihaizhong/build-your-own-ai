...
class PHReg(model.LikelihoodModel):
    ...
    @classmethod
    def from_formula(cls, formula, data, status=..., entry=..., strata=..., offset=..., subset=..., ties=..., missing=..., *args, **kwargs): # -> Self:
        """
    ...
    def score(self, params): # -> float | None:
        """
        Returns the score function evaluated at `params`.
        """
        ...
    
    def hessian(self, params): # -> float | Any | NDArray[floating[Any]]:
        """
    ...
    def breslow_gradient(self, params): # -> float:
        """
    ...
    def efron_gradient(self, params): # -> float:
        """
    ...
    def breslow_hessian(self, params): # -> float | Any | NDArray[floating[Any]]:
        """
    ...
    def efron_hessian(self, params): # -> float | Any:
        """
    ...
    def score_residuals(self, params): # -> NDArray[floating[_64Bit]]:
        """
    ...
    def weighted_covariate_averages(self, params): # -> list[Any]:
        """
    ...
    def baseline_cumulative_hazard(self, params): # -> list[Any]:
        """
    ...
    def baseline_cumulative_hazard_function(self, params): # -> dict[Any, Any]:
        """
    ...
    def predict(self, params, exog=..., cov_params=..., endog=..., strata=..., offset=..., pred_type=..., pred_only=...): # -> Any | bunch | None:
        class bunch:
            ...
        
        
    
    def get_distribution(self, params, scale=..., exog=...): # -> rv_discrete_float:
        """
...
class PHRegResults(base.LikelihoodModelResults):
    ...
    def predict(self, endog=..., exog=..., strata=..., offset=..., transform=..., pred_type=...): # -> Series[Any] | DataFrame:
        ...
