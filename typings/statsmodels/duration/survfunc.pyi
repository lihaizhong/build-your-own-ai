...
class SurvfuncRight:
    ...
    def quantile(self, p): # -> float | ndarray[Any, dtype[intp]] | ndarray[Any, dtype[Any]]:
        """
    ...
    def quantile_ci(self, p, alpha=..., method=...): # -> tuple[float, float] | tuple[Any | ndarray[Any, dtype[intp]] | ndarray[Any, dtype[Any]], float | Any | ndarray[Any, dtype[intp]] | ndarray[Any, dtype[Any]]]:
        """
    ...
    def simultaneous_cb(self, alpha=..., method=..., transform=...): # -> tuple[NDArray[floating[Any]] | Any | NDArray[signedinteger[Any]], NDArray[floating[Any]] | Any | NDArray[Any] | NDArray[signedinteger[Any]]]:
        """
...
def survdiff(time, status, group, weight_type=..., strata=..., entry=..., **kwargs): # -> tuple[Any, NDArray[signedinteger[Any]]]:
    """
