...
class GLS(RegressionModel):
    ...
    def hessian_factor(self, params, scale=..., observed=...): # -> NDArray[float64] | NDArray[Any]:
        """
...
class GLSAR(GLS):
    ...
    def whiten(self, x): # -> ndarray[Any, dtype[floating[_64Bit]]]:
        """
...
def yule_walker(x, order=..., method=..., df=..., inv=..., demean=...): # -> tuple[NDArray[floating[Any]], Any | float, NDArray[float64]] | tuple[NDArray[floating[Any]], Any | float]:
    """
...
def burg(endog, order=..., demean=...): # -> tuple[ndarray[Any, dtype[Any]], Any]:
    """
...
class RegressionResults(base.LikelihoodModelResults):
    ...
    **kwargs
    ...
    @cache_readonly
    def eigenvals(self): # -> ndarray[Any, dtype[Any]]:
        """
    ...
    def compare_lm_test(self, restricted, demean=..., use_lr=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any]:
        """
    ...
    def compare_f_test(self, restricted): # -> tuple[Any, ndarray[Any, dtype[Any]], Any]:
        """
    ...
    def compare_lr_test(self, restricted, large_sample=...): # -> tuple[Any, ndarray[Any, dtype[Any]], Any]:
        """
...
class OLSResults(RegressionResults):
    ...
    **kwargs
    ...
    def el_test(self, b0_vals, param_nums, return_weights=..., ret_params=..., method=..., stochastic_exog=...): # -> tuple[Any | float, NDArray[signedinteger[Any]], Any] | tuple[Any | float, NDArray[signedinteger[Any]]] | tuple[Any, NDArray[signedinteger[Any]], Any, Any] | tuple[Any, NDArray[signedinteger[Any]], Any] | tuple[Any, NDArray[signedinteger[Any]]]:
        """
